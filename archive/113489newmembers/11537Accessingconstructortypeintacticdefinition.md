...
#### [Jesse Michael Han (Oct 18 2018 at 06:22)](https://leanprover.zulipchat.com/#narrow/stream/113489-new members/topic/Accessing constructor type in tactic definition/near/136019547):
Hello everyone,
...
#### [Johan Commelin (Oct 18 2018 at 06:25)](https://leanprover.zulipchat.com/#narrow/stream/113489-new members/topic/Accessing constructor type in tactic definition/near/136019612):
@**Jesse Michael Han** Your to goals are tagged with a descriptive name. It contains "foo" and "bar".

#### [Johan Commelin (Oct 18 2018 at 06:26)](https://leanprover.zulipchat.com/#narrow/stream/113489-new members/topic/Accessing constructor type in tactic definition/near/136019652):
Your actual "foo" and "bar" is still called `hello`.

#### [Johan Commelin (Oct 18 2018 at 06:27)](https://leanprover.zulipchat.com/#narrow/stream/113489-new members/topic/Accessing constructor type in tactic definition/near/136019660):
...
#### [Johan Commelin (Oct 18 2018 at 06:27)](https://leanprover.zulipchat.com/#narrow/stream/113489-new members/topic/Accessing constructor type in tactic definition/near/136019661):
My point is, you can close the goal with ~~`exact hello`~~ (see below).

#### [Mario Carneiro (Oct 18 2018 at 06:28)](https://leanprover.zulipchat.com/#narrow/stream/113489-new members/topic/Accessing constructor type in tactic definition/near/136019707):
well, I think he wants `exact 0, exact 1`

#### [Bryan Gin-ge Chen (Oct 18 2018 at 06:28)](https://leanprover.zulipchat.com/#narrow/stream/113489-new members/topic/Accessing constructor type in tactic definition/near/136019709):
...
#### [Jesse Michael Han (Oct 18 2018 at 06:46)](https://leanprover.zulipchat.com/#narrow/stream/113489-new members/topic/Accessing constructor type in tactic definition/near/136020216):
...
#### [Bryan Gin-ge Chen (Oct 18 2018 at 06:51)](https://leanprover.zulipchat.com/#narrow/stream/113489-new members/topic/Accessing constructor type in tactic definition/near/136020333):
What's the actual thing you're trying to do? `have := hewwo.foo` only gives you a hypothesis `this : ℕ → hewwo`.

#### [Bryan Gin-ge Chen (Oct 18 2018 at 06:57)](https://leanprover.zulipchat.com/#narrow/stream/113489-new members/topic/Accessing constructor type in tactic definition/near/136020477):
Oh, I misread your first message. I guess that's what you wanted after all.

#### [Jesse Michael Han (Oct 18 2018 at 07:08)](https://leanprover.zulipchat.com/#narrow/stream/113489-new members/topic/Accessing constructor type in tactic definition/near/136020878):
...
#### [Bryan Gin-ge Chen (Oct 18 2018 at 07:32)](https://leanprover.zulipchat.com/#narrow/stream/113489-new members/topic/Accessing constructor type in tactic definition/near/136021621):
...
#### [Jesse Michael Han (Oct 18 2018 at 07:47)](https://leanprover.zulipchat.com/#narrow/stream/113489-new members/topic/Accessing constructor type in tactic definition/near/136022027):
> Note that have := hewwo.foo doesn't depend on anything the cases statement introduces. You can write it before or after the cases statement with exactly the same effect. All the have tactic does is introduce a new term into the tactic state. Furthermore, all that lean remembers from have is the type of the term after :=, so it's mostly useful for introducing proof terms and not data. In particular, you can check that the tactic state is the same whether you write have := hewwo.foo or have := hewwo.bar. 
