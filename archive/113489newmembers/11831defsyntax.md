...
#### [Alexandru-Andrei Bosinta (Nov 21 2018 at 21:04)](https://leanprover.zulipchat.com/#narrow/stream/113489-new members/topic/def syntax/near/148134203):
...
#### [Johannes Hölzl (Nov 21 2018 at 21:39)](https://leanprover.zulipchat.com/#narrow/stream/113489-new members/topic/def syntax/near/148135957):
...
#### [Kevin Buzzard (Nov 21 2018 at 21:39)](https://leanprover.zulipchat.com/#narrow/stream/113489-new members/topic/def syntax/near/148135962):
```lean
...
#### [Johannes Hölzl (Nov 21 2018 at 21:39)](https://leanprover.zulipchat.com/#narrow/stream/113489-new members/topic/def syntax/near/148135985):
ah yes, `priority 0` is a good idea

#### [Alexandru-Andrei Bosinta (Nov 21 2018 at 21:51)](https://leanprover.zulipchat.com/#narrow/stream/113489-new members/topic/def syntax/near/148136595):
...
#### [Kevin Buzzard (Nov 21 2018 at 21:52)](https://leanprover.zulipchat.com/#narrow/stream/113489-new members/topic/def syntax/near/148136656):
Maybe you want `dite`? "dependent if/then/else"

#### [Rob Lewis (Nov 21 2018 at 21:53)](https://leanprover.zulipchat.com/#narrow/stream/113489-new members/topic/def syntax/near/148136673):
`if h : p then _ else _`

#### [Alexandru-Andrei Bosinta (Nov 21 2018 at 22:10)](https://leanprover.zulipchat.com/#narrow/stream/113489-new members/topic/def syntax/near/148137486):
```quote
`if h : p then _ else _`
```
...
#### [Alexandru-Andrei Bosinta (Nov 21 2018 at 22:13)](https://leanprover.zulipchat.com/#narrow/stream/113489-new members/topic/def syntax/near/148137657):
```quote
Maybe you want `dite`? "dependent if/then/else"
```
...
#### [Rob Lewis (Nov 21 2018 at 22:21)](https://leanprover.zulipchat.com/#narrow/stream/113489-new members/topic/def syntax/near/148138067):
`if h : p then _ else _` is actually just nicer syntax for `dite`.

#### [Alexandru-Andrei Bosinta (Nov 21 2018 at 23:14)](https://leanprover.zulipchat.com/#narrow/stream/113489-new members/topic/def syntax/near/148140541):
...
#### [Patrick Massot (Nov 21 2018 at 23:18)](https://leanprover.zulipchat.com/#narrow/stream/113489-new members/topic/def syntax/near/148140724):
use `classical.some`

#### [Patrick Massot (Nov 21 2018 at 23:18)](https://leanprover.zulipchat.com/#narrow/stream/113489-new members/topic/def syntax/near/148140739):
but beware that you don't get much control over which element will be returned

#### [Patrick Massot (Nov 21 2018 at 23:20)](https://leanprover.zulipchat.com/#narrow/stream/113489-new members/topic/def syntax/near/148140835):
and of course your function won't be computable

#### [Patrick Massot (Nov 21 2018 at 23:21)](https://leanprover.zulipchat.com/#narrow/stream/113489-new members/topic/def syntax/near/148140845):
Maybe it would help, if you could tell us more about what you are actually trying to do

#### [Alexandru-Andrei Bosinta (Nov 21 2018 at 23:24)](https://leanprover.zulipchat.com/#narrow/stream/113489-new members/topic/def syntax/near/148140975):
...
#### [Patrick Massot (Nov 21 2018 at 23:25)](https://leanprover.zulipchat.com/#narrow/stream/113489-new members/topic/def syntax/near/148141013):
...
#### [Patrick Massot (Nov 21 2018 at 23:28)](https://leanprover.zulipchat.com/#narrow/stream/113489-new members/topic/def syntax/near/148141147):
I mean
```lean
...
#### [Alexandru-Andrei Bosinta (Nov 21 2018 at 23:37)](https://leanprover.zulipchat.com/#narrow/stream/113489-new members/topic/def syntax/near/148141536):
...
#### [Patrick Massot (Nov 21 2018 at 23:43)](https://leanprover.zulipchat.com/#narrow/stream/113489-new members/topic/def syntax/near/148141768):
...
#### [Alexandru-Andrei Bosinta (Nov 21 2018 at 23:45)](https://leanprover.zulipchat.com/#narrow/stream/113489-new members/topic/def syntax/near/148141840):
Ok, I will post it here when I am done.

#### [Alexandru-Andrei Bosinta (Nov 22 2018 at 02:18)](https://leanprover.zulipchat.com/#narrow/stream/113489-new members/topic/def syntax/near/148147423):
```
...
#### [Kenny Lau (Nov 22 2018 at 16:41)](https://leanprover.zulipchat.com/#narrow/stream/113489-new members/topic/def syntax/near/148182360):
