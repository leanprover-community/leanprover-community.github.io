...
#### [Luca Gerolla (Jul 05 2018 at 21:35)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/129159440):
...
#### [Luca Gerolla (Jul 05 2018 at 21:35)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/129159458):
What would be the best way to define a path? Also avoiding the ** type mismatch ** that arises in the definition?

#### [Patrick Massot (Jul 05 2018 at 21:49)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/129160116):
I don't understand what you are trying to do. But you could have a look at `data/sets/intervals` in mathlib

#### [Patrick Massot (Jul 05 2018 at 21:49)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/129160140):
...
#### [Luca Gerolla (Jul 05 2018 at 22:20)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/129161964):
```quote
But actually it may be better to have path as a structure bundling a map from reals to X and the condition that it is continuous on [0, 1].
```
...
#### [Luca Gerolla (Jul 05 2018 at 22:24)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/129162181):
```quote
I don't understand what you are trying to do. But you could have a look at `data/sets/intervals` in mathlib
```
...
#### [Johan Commelin (Jul 06 2018 at 08:43)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/129185328):
A path is just a continuous function `I \to X`, right? Or do you want a Type for paths from `x` to `y`?

#### [Patrick Massot (Jul 06 2018 at 09:18)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/129186563):
It looks like he wants the end points to be parameters of the type

#### [Kevin Buzzard (Jul 06 2018 at 09:47)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/129187672):
...
#### [Luca Gerolla (Jul 06 2018 at 09:47)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/129187690):
...
#### [Kevin Buzzard (Jul 06 2018 at 09:49)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/129187750):
...
#### [Kevin Buzzard (Jul 06 2018 at 09:52)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/129187876):
...
#### [Mario Carneiro (Jul 06 2018 at 09:52)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/129187887):
In this case you definitely want `x` and `y` outside the structure

#### [Kevin Buzzard (Jul 06 2018 at 09:52)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/129187895):
Why?

#### [Mario Carneiro (Jul 06 2018 at 09:53)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/129187906):
> a Type for paths from `x` to `y`

#### [Kevin Buzzard (Jul 06 2018 at 09:53)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/129187913):
:-)

#### [Luca Gerolla (Jul 06 2018 at 09:53)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/129187916):
```quote
Hey Luca. So just to comment that `set ℝ` is a type so `I` is "only" a term. So when you make `topological_space I` something magic is happening: the term is being somehow promoted to a type. What's happening is that the term `  {x : ℝ | x ≤ 1 ∧ x ≥ 0}`(which is really a function) is being interpreted as the type `{x : ℝ // x ≤ 1 ∧ x ≥ 0}` implicitly (and this is a so-called subtype).  So when you write `t : I` then `t` might not be what you think it is -- it's a term of the subtype, so it has a value `t.val` which is the real number, and then a proof too, called `t.property`.
...
#### [Kevin Buzzard (Jul 06 2018 at 09:53)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/129187924):
and Mario is saying that you want the first of my three options above.

#### [Kevin Buzzard (Jul 06 2018 at 09:54)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/129187976):
...
#### [Patrick Massot (Jul 06 2018 at 09:57)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/129188095):
There is also the option of having the path "defined" on R but only use its values and continuity on I

#### [Patrick Massot (Jul 06 2018 at 09:57)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/129188102):
...
#### [Mario Carneiro (Jul 06 2018 at 10:04)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/129188404):
...
#### [Kevin Buzzard (Jul 06 2018 at 10:05)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/129188438):
...
#### [Mario Carneiro (Jul 06 2018 at 10:05)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/129188441):
...
#### [Patrick Massot (Jul 06 2018 at 10:06)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/129188490):
Note again that mathlib does have a rudimentary theory of intervals (in totally ordered types).

#### [Mario Carneiro (Jul 06 2018 at 10:06)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/129188497):
Indeed you can prove that `I01` is compact in one line

#### [Patrick Massot (Jul 06 2018 at 10:07)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/129188505):
...
#### [Kevin Buzzard (Jul 06 2018 at 10:07)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/129188506):
...
#### [Patrick Massot (Jul 06 2018 at 10:07)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/129188516):
...
#### [Mario Carneiro (Jul 06 2018 at 10:08)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/129188567):
The solution to this is to define appropriate functions on `I01` so that you abstract away the proof stuff

#### [Mario Carneiro (Jul 06 2018 at 10:09)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/129188573):
For example you can probably get away with just a `has_mul` instance (the usual one) and a `has_neg` instance (the 1-x function)

#### [Patrick Massot (Jul 06 2018 at 10:09)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/129188574):
...
#### [Mario Carneiro (Jul 06 2018 at 10:10)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/129188622):
Also 1/2 should be a point in [0,1]

#### [Patrick Massot (Jul 06 2018 at 10:10)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/129188624):
exactly

#### [Mario Carneiro (Jul 06 2018 at 10:10)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/129188629):
from those I think you have enough to define everything else in homotopy theory

#### [Kevin Buzzard (Jul 06 2018 at 10:12)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/129188696):
...
#### [Patrick Massot (Jul 06 2018 at 10:13)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/129188705):
It's not quite true: Johan tried it

#### [Patrick Massot (Jul 06 2018 at 10:14)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/129188736):
https://github.com/leanprover/mathlib/pull/144

#### [Patrick Massot (Jul 06 2018 at 10:14)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/129188748):
this has some intersection with what Luca wants to try

#### [Kevin Buzzard (Jul 06 2018 at 10:14)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/129188750):
Oh! Luca -- this is Johan Commelin. You might want to look at what he did (or you might want to figure it out yourself)

#### [Kevin Buzzard (Jul 06 2018 at 10:14)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/129188752):
Thanks Patrick.

#### [Patrick Massot (Jul 06 2018 at 10:14)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/129188758):
but it's geared towards homology, and biased towards abstraction (simplicial sets everywhere)

#### [Luca Gerolla (Jul 06 2018 at 10:18)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/129188888):
This is all very interesting, thank you very much everyone! :-)

#### [Luca Gerolla (Jul 21 2018 at 13:41)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130051069):
...
#### [Luca Gerolla (Jul 21 2018 at 13:42)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130051111):
This is my code: 
```lean
...
#### [Mario Carneiro (Jul 21 2018 at 13:45)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130051195):
there are way too many topological space arguments in `fun_match`

#### [Luca Gerolla (Jul 21 2018 at 13:45)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130051196):
Any help would be greatly appreciated

#### [Mario Carneiro (Jul 21 2018 at 13:46)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130051245):
```
def fun_match {X Y} {A B : set X} (fa : A → Y) (fb : B → Y) : Prop :=
∀ x h₁ h₂, fa ⟨x, h₁⟩ = fb ⟨x, h₂⟩
```

#### [Mario Carneiro (Jul 21 2018 at 13:51)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130051367):
```
...
#### [Mario Carneiro (Jul 21 2018 at 13:51)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130051387):
we don't really need topology to define these functions; it only comes in for the continuity proof

#### [Mario Carneiro (Jul 21 2018 at 13:56)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130051589):
...
#### [Kenny Lau (Jul 21 2018 at 13:56)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130051606):
do we really want to use the name `fun_match`? It is really similar to the internally generated variable `_fun_match`

#### [Mario Carneiro (Jul 21 2018 at 13:57)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130051616):
that's fair

#### [Mario Carneiro (Jul 21 2018 at 13:57)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130051623):
mathlib uses `eq_on` for something very similar

#### [Luca Gerolla (Jul 23 2018 at 12:42)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130141208):
...
#### [Luca Gerolla (Jul 23 2018 at 12:50)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130141517):
...
#### [Kevin Buzzard (Jul 23 2018 at 21:53)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130170170):
...
#### [Nicholas Scheel (Jul 24 2018 at 02:32)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130182032):
...
#### [Luca Gerolla (Jul 24 2018 at 11:09)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130200013):
```quote
If you want to prove two functions are equal, the `funext` tactic reduces you to checking their values are equal on every input. This might be what you need?
```
...
#### [Chris Hughes (Jul 24 2018 at 11:13)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130200168):
have you tried `simp` or `rw subtype.eta x.1 x.2`

#### [Mario Carneiro (Jul 24 2018 at 11:13)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130200179):
`cases x` will make this a lot easier

#### [Luca Gerolla (Jul 24 2018 at 11:14)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130200222):
Yes, simp does work! Thank you Chris, very silly of me not trying it.. sorry!

#### [Luca Gerolla (Jul 24 2018 at 11:42)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130201370):
```lean
lemma rest_of_paste {X : Type* } {Y : Type*} {A B : set X} {Hunion : A ∪ B = set.univ} (fa : A → Y) (fb : B → Y)
...
#### [Luca Gerolla (Jul 24 2018 at 11:43)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130201385):
...
#### [Kevin Buzzard (Jul 24 2018 at 13:07)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130204505):
```quote
Is there a way to prove ` fa x = fa ⟨x.val, ?m_1⟩ `?  (I thought the `have`s should do the job but then `rw H1` fails )
```
...
#### [Mario Carneiro (Jul 24 2018 at 13:07)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130204515):
the easy proof is `cases x, refl`

#### [Mario Carneiro (Jul 24 2018 at 13:08)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130204566):
I usually do cases on a variable like this before proofs, because everything becomes definitionally true that way

#### [Nicholas Scheel (Jul 24 2018 at 18:07)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130220203):
@**Luca Gerolla** yes that’s what I meant, but it‘s not a big deal either way – looks like you’re making progress on it already :)

#### [Kevin Buzzard (Jul 25 2018 at 02:00)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130245778):
...
#### [Kevin Buzzard (Jul 25 2018 at 02:00)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130245786):
```lean
...
#### [Kevin Buzzard (Jul 25 2018 at 02:01)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130245821):
...
#### [Kevin Buzzard (Jul 25 2018 at 02:02)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130245882):
```lean
import analysis.topology.topological_space
...
#### [Kevin Buzzard (Jul 25 2018 at 02:03)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130245885):
My MWE works :-/

#### [Chris Hughes (Jul 25 2018 at 02:08)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130246071):
It can infer a topological space structure on `{vs : Spv R // Spv.is_continuous vs}` but not if you give it a different names.

#### [Chris Hughes (Jul 25 2018 at 02:08)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130246074):
because type class inference looks at the `expr`

#### [Kevin Buzzard (Jul 25 2018 at 02:09)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130246087):
So am I OK to make the instance like I did?

#### [Kevin Buzzard (Jul 25 2018 at 02:09)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130246091):
I don't want to make diamonds

#### [Chris Hughes (Jul 25 2018 at 02:10)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130246138):
Don't see why not. It's a defeq diamond, and it's not even a diamond really because there's only one path it will choose.

#### [Kevin Buzzard (Jul 25 2018 at 02:11)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130246147):
Thanks Chris.

#### [Mario Carneiro (Jul 25 2018 at 09:33)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130259969):
...
#### [Kevin Buzzard (Jul 25 2018 at 10:42)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130262773):
...
#### [Mario Carneiro (Jul 25 2018 at 10:44)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130262843):
yes, it only unfolds `reducible` definitions

#### [Mario Carneiro (Jul 25 2018 at 10:45)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130262867):
This is a good thing, because it means you can attach different typeclasses to defeq things, like `with_top A = with_bot A`

#### [Mario Carneiro (Jul 25 2018 at 10:46)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130262892):
So naming a def is a way of controlling what typeclasses you want to inherit

#### [Johan Commelin (Jul 25 2018 at 10:46)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130262934):
...
#### [Mario Carneiro (Jul 25 2018 at 10:46)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130262943):
I find that it is almost never a good idea to mark a definition `reducible`

#### [Kevin Buzzard (Jul 25 2018 at 10:50)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130263136):
You make it reducible and any goal with `Cont` in just gets unfolded and looks more unreadable. I think.

#### [Johan Commelin (Jul 25 2018 at 10:51)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130263163):
Yes, so let's not do that. After all, `unfold`ing isn't very hard to do, if we need it.

#### [Luca Gerolla (Jul 27 2018 at 16:20)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130413232):
...
#### [Kenny Lau (Jul 27 2018 at 16:20)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130413243):
it's even compact

#### [Luca Gerolla (Jul 27 2018 at 16:20)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130413266):
```quote
it's even compact
```
Indeed! :)

#### [Kenny Lau (Jul 27 2018 at 16:21)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130413279):
what I mean is it's even proved that it is compact

#### [Reid Barton (Jul 27 2018 at 16:21)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130413304):
Check out the stuff around `ordered_topology` in `analysis.topology.topological_structures`, such as `is_closed_le`

#### [Luca Gerolla (Jul 27 2018 at 16:21)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130413315):
Oh, haven't thought to approach it from compactness..

#### [Kenny Lau (Jul 27 2018 at 16:22)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130413384):
...
#### [Kevin Buzzard (Jul 27 2018 at 16:34)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130414100):
...
#### [Mario Carneiro (Jul 27 2018 at 16:52)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130415106):
`is_closed_Icc`
https://github.com/leanprover/mathlib/blob/master/analysis/topology/topological_structures.lean#L282-L283

#### [Mario Carneiro (Jul 27 2018 at 16:55)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130415280):
mathlib doesn't really use `theorem` vs `lemma` distinction (or at least I don't like to make this distinction)

#### [Mario Carneiro (Jul 27 2018 at 16:57)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130415388):
...
#### [Luca Gerolla (Jul 27 2018 at 17:00)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130415529):
```quote
Check out the stuff around `ordered_topology` in `analysis.topology.topological_structures`, such as `is_closed_le`
```
...
#### [Luca Gerolla (Jul 27 2018 at 17:02)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Topology - Beginner/near/130415717):
