...
#### [Sean Leather (Apr 13 2018 at 14:37)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125032331):
Is there a way to get a `list` from a `finset` without using `finset.sort` or writing my own recursive function on `finset`?

#### [Kenny Lau (Apr 13 2018 at 14:38)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125032374):
but `finset` is a subquotient of `list`

#### [Kenny Lau (Apr 13 2018 at 14:38)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125032377):
and quotients can't be reversed

#### [Sean Leather (Apr 13 2018 at 14:39)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125032390):
That's right, so I couldn't use a recursive function anyway.

#### [Sean Leather (Apr 13 2018 at 14:43)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125032522):
...
#### [Sean Leather (Apr 13 2018 at 14:48)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125032728):
Ah, `fold`?

#### [Simon Hudon (Apr 13 2018 at 14:50)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125032788):
Why do you not want to sort it?

#### [Sean Leather (Apr 13 2018 at 14:50)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125032790):
Because I don't need a particular order.

#### [Kenny Lau (Apr 13 2018 at 14:50)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125032791):
then it's uncomputable

#### [Simon Hudon (Apr 13 2018 at 14:52)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125032857):
Right but them being in a particular order can't be harmful, is it? Is it that you care about the performances?

#### [Sean Leather (Apr 13 2018 at 14:53)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125032874):
It requires adding an ordering constraint to the elements that I don't need or want.

#### [Simon Hudon (Apr 13 2018 at 14:53)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125032878):
...
#### [Sean Leather (Apr 13 2018 at 14:55)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125032951):
```lean
...
#### [Kenny Lau (Apr 13 2018 at 14:56)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125033001):
```quote
It requires adding an ordering constraint to the elements that I don't need or want.
```
otherwise it won't be a well-defined function

#### [Simon Hudon (Apr 13 2018 at 15:01)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125033199):
```quote
```lean
def multiset.foldr (f : α → β → β) (H : left_commutative f) (b : β) (s : multiset α) : β :=
quot.lift_on s (λ l, foldr f b l) (λ l₁ l₂ p, foldr_eq_of_perm H p b)
...
#### [Sean Leather (Apr 13 2018 at 15:10)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125033557):
...
#### [Kenny Lau (Apr 13 2018 at 15:10)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125033566):
right, because the function you're trying to define isn't well-defined

#### [Sean Leather (Apr 13 2018 at 15:11)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125033577):
Since `finset` is a quotient on list permutations, is it not possible to choose an arbitrary permutation?

#### [Kenny Lau (Apr 13 2018 at 15:11)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125033582):
no, that's what quotient is

#### [Kenny Lau (Apr 13 2018 at 15:11)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125033583):
it needs to work for any permutation

#### [Kenny Lau (Apr 13 2018 at 15:12)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125033643):
your functions need to be well-defined

#### [Kenny Lau (Apr 13 2018 at 15:13)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125033652):
if {2,1,3} gives [2,1,3] and {1,2,3} gives [1,2,3], then it isn't a well-defined function

#### [Chris Hughes (Apr 13 2018 at 15:13)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125033654):
`quotient.out` works, but that's noncomputable

#### [Chris Hughes (Apr 13 2018 at 15:13)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125033665):
`quot.unquot` also works, but you can't use that in a proof, because it implies false.

#### [Kenny Lau (Apr 13 2018 at 15:14)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125033708):
in fact, if your function did that, then I can prove false

#### [Kenny Lau (Apr 13 2018 at 15:14)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125033714):
because {2,1,3} and {1,2,3} are equal

#### [Sean Leather (Apr 13 2018 at 15:17)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125033803):
...
#### [Simon Hudon (Apr 13 2018 at 15:35)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125034441):
...
#### [Sean Leather (Apr 13 2018 at 15:35)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125034446):
...
#### [Simon Hudon (Apr 13 2018 at 15:36)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125034447):
Instead of going inside the `quot` to extract a list, go inside to do more of your computations

#### [Kevin Buzzard (Apr 13 2018 at 15:48)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125034894):
Sean -- you want your function to be computable?

#### [Sean Leather (Apr 19 2018 at 08:30)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125291437):
...
#### [Mario Carneiro (Apr 19 2018 at 08:36)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125291609):
...
#### [Sean Leather (Apr 19 2018 at 08:37)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125291625):
How so?

#### [Mario Carneiro (Apr 19 2018 at 08:37)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125291630):
It makes the code path a bit more obvious

#### [Mario Carneiro (Apr 19 2018 at 08:38)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125291682):
I always worry that the match and such will add extra overhead

#### [Mario Carneiro (Apr 19 2018 at 08:38)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125291688):
it's not clear to me whether it is in fact optimized away

#### [Sean Leather (Apr 19 2018 at 08:38)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125291689):
What type signature would you want?

#### [Mario Carneiro (Apr 19 2018 at 08:42)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125291854):
```
...
#### [Sean Leather (Apr 19 2018 at 08:46)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125291994):
Ah, I see what you mean. You're talking about splitting the methods of the `class`. Yeah, that seems fine, assuming it works.

#### [Mario Carneiro (Apr 19 2018 at 08:47)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125292003):
...
#### [Sean Leather (Apr 19 2018 at 09:36)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125293488):
```quote
By the way, it is conceivable that `fresh` in the typeclass will be difficult to define, since it enforces that the fresh element not depend on the order of the input list
```
...
#### [Mario Carneiro (Apr 19 2018 at 09:39)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125293581):
...
#### [Sean Leather (Apr 19 2018 at 13:31)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125301276):
```quote
...
#### [Mario Carneiro (Apr 19 2018 at 13:32)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125301322):
every function on `finset` is ultimately the `lift` of a function on `list`

#### [Mario Carneiro (Apr 19 2018 at 13:32)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125301327):
I assume you used `finset.fold` or something to define the nat function

#### [Sean Leather (Apr 19 2018 at 13:33)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/list from a finset/near/125301330):
