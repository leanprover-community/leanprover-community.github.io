...
#### [Kevin Buzzard (Oct 07 2018 at 01:52)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/What's with the `_` in `zero_`?/near/135330352):
...
#### [Mario Carneiro (Oct 07 2018 at 02:47)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/What's with the `_` in `zero_`?/near/135331864):
I think we are using `'` for this now

#### [Mario Carneiro (Oct 07 2018 at 02:47)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/What's with the `_` in `zero_`?/near/135331865):
it's avoiding a name clash with a restated axiom just below it

#### [Kevin Buzzard (Oct 07 2018 at 09:43)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/What's with the `_` in `zero_`?/near/135342852):
