...
### Topic: [is continuum hypothesis true in Lean?](https://leanprover-community.github.io/archive/116395maths/73541iscontinuumhypothesistrueinLean.html)
...
<p>Is the continuum hypothesis true in Lean’s model of ZFC?</p>
...
<p>it’s a model, it can’t be independent</p>
...
<p>Oh yes, what you can (directly) prove inside Lean is of course only that CH is independent of ZFC...  However CH is still independent of Lean.</p>
...
<p><span class="user-mention" data-user-id="110043">@Gabriel Ebner</span> I mean, we do have a model of ZFC, where "CH" is one specific sentence that can either be true or false</p>
...
<p>so I wonder if it is true or false in that specific model of ZFC</p>
...
<p><span class="user-mention" data-user-id="110049">@Mario Carneiro</span> maybe you have some idea</p>
...
<p>We have a model of ZFC inside a model of Lean inside a model of ZFC (+ some large cardinals); and CH is true in the inner ZFC model iff CH is true in the outer ZFC model.  Since we can choose CH or ¬CH for the outer ZFC model, Set⊧CH should be independent of Lean.</p>
...
<p>I have a hard time believing your claim, since a model has a valuation making statements either true or false, right?</p>
...
<p>things can't be independent in a model</p>
...
<p>if a sentence phi is independent of a theory, then phi is true in some models of the theory and false in others</p>
...
<p>Indeed, CH is either true or false in the model. It is true in the model if it is true in the metatheory, and false in the model if it is false in the metatheory.</p>
...
<p>or is this one of those things that would take 1000 lines?</p>
...
<p>assume, meaning have it as a variable</p>
...
<p>Assuming CH outside isn't going to help you construct any proofs, presumably.</p>
...
<p>but you said that if CH is true outside then CH is true inside</p>
...
<p>I mean, proofs inside the system. It will be true inside the model.</p>
...
<p>(actually if lean |- X then ZFC+inaccessibles |- X, but it is known that large cardinals don't affect the independence of CH.)</p>
