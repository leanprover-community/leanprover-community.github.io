...
#### [![Click to go to Zulip](../../assets/img/zulip2.png) Kevin Buzzard (Apr 10 2018 at 11:14)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/promoting%20equiv/near/124877560):
I have seen this really full in the face in my work on schemes

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Kevin Buzzard (Apr 10 2018 at 11:15)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/promoting%20equiv/near/124877565):
I am defining a certain gadget in algebraic geometry called "the structure sheaf on an affine scheme"

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Kevin Buzzard (Apr 10 2018 at 11:16)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/promoting%20equiv/near/124877586):
...
#### [![Click to go to Zulip](../../assets/img/zulip2.png) Kevin Buzzard (Apr 10 2018 at 11:16)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/promoting%20equiv/near/124877624):
and the catch is that the open set can be of the form $$D(g)$$ for other elements $$g$$ of the ring

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Kevin Buzzard (Apr 10 2018 at 11:17)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/promoting%20equiv/near/124877627):
but $$R[1/f]$$ and $$R[1/g]$$ are isomorphic

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Kevin Buzzard (Apr 10 2018 at 11:17)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/promoting%20equiv/near/124877637):
...
#### [![Click to go to Zulip](../../assets/img/zulip2.png) Kevin Buzzard (Apr 10 2018 at 11:18)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/promoting%20equiv/near/124877682):
Now if this isomorphism were an equality, then `eq.rec` would be really helpful

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Kevin Buzzard (Apr 10 2018 at 11:19)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/promoting%20equiv/near/124877691):
because I would be able to promote a claim involving $$R[1/f]$$ to a claim involving any $$R[1/g]$$

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Kevin Buzzard (Apr 10 2018 at 11:19)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/promoting%20equiv/near/124877697):
But it's not an equality -- $$R[1/f]$$ and $$R[1/g]$$ are most definitely different types

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Gabriel Ebner (Apr 10 2018 at 11:19)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/promoting%20equiv/near/124877700):
...
#### [![Click to go to Zulip](../../assets/img/zulip2.png) Kevin Buzzard (Apr 10 2018 at 11:23)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/promoting%20equiv/near/124877840):
...
#### [![Click to go to Zulip](../../assets/img/zulip2.png) Kevin Buzzard (Apr 10 2018 at 11:28)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/promoting%20equiv/near/124878016):
...
#### [![Click to go to Zulip](../../assets/img/zulip2.png) Kevin Buzzard (Apr 10 2018 at 11:36)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/promoting%20equiv/near/124878261):
...
#### [![Click to go to Zulip](../../assets/img/zulip2.png) Kevin Buzzard (Apr 10 2018 at 11:56)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/promoting%20equiv/near/124878938):
https://stacks.math.columbia.edu/tag/00EJ

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Kevin Buzzard (Apr 10 2018 at 11:56)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/promoting%20equiv/near/124878949):
to the statement that the sheaf axiom holds for finite covers of Spec(R) by basic open sets of the form D(f_i)

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Kevin Buzzard (Apr 10 2018 at 11:57)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/promoting%20equiv/near/124878957):
and the proof is "those two statements say the same thing"

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Kevin Buzzard (Apr 10 2018 at 11:57)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/promoting%20equiv/near/124878976):
...
#### [![Click to go to Zulip](../../assets/img/zulip2.png) Kevin Buzzard (Apr 10 2018 at 11:58)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/promoting%20equiv/near/124879020):
But the problem is that if $$U$$ is an open set which equals $$D(f)$$ for some $$f$$

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Kevin Buzzard (Apr 10 2018 at 11:58)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/promoting%20equiv/near/124879024):
then it is almost certainly equal to $$D(g)$$ for lots of other $$g$$

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Kevin Buzzard (Apr 10 2018 at 11:59)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/promoting%20equiv/near/124879033):
and I am not allowed to define the global sections on $$D(f)$$ to be $$R[1/f]$$

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Kevin Buzzard (Apr 10 2018 at 11:59)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/promoting%20equiv/near/124879035):
because this involves choosing $$f$$.

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Kevin Buzzard (Apr 10 2018 at 12:00)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/promoting%20equiv/near/124879080):
So like you say I can do some projective limit construction over all $$g$$ with $$D(f)=D(g)$$

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Kevin Buzzard (Apr 10 2018 at 12:00)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/promoting%20equiv/near/124879084):
[the equivalence relation on $$R$$ is that `f` and `g` are equivalent iff $$D(f)=D(g)$$]

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Kevin Buzzard (Apr 10 2018 at 12:01)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/promoting%20equiv/near/124879091):
or I could also do some construction involving inverting all $$g$$ which are non-vanishing on $$U$$

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Kevin Buzzard (Apr 10 2018 at 12:01)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/promoting%20equiv/near/124879096):
and either way I get a new ring which is not definitionally equal to $$R[1/f]$$

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Kevin Buzzard (Apr 10 2018 at 12:01)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/promoting%20equiv/near/124879099):
but which is uniquely isomorphic to it as $$R$$-algebra

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Kevin Buzzard (Apr 10 2018 at 12:01)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/promoting%20equiv/near/124879102):
and now I have to push the diagram chase over

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Kevin Buzzard (Apr 10 2018 at 12:01)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/promoting%20equiv/near/124879103):
