...
#### [Kevin Buzzard (Sep 09 2018 at 02:47)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133588233):
...
#### [Mario Carneiro (Sep 09 2018 at 03:06)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133588722):
Do we have left-regular elements?

#### [Mario Carneiro (Sep 09 2018 at 03:07)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133588727):
i.e. non-zero divisors

#### [Mario Carneiro (Sep 09 2018 at 03:09)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133588774):
I would suggest using integral domain properties but I guess you don't have that in a comm_semiring

#### [Chris Hughes (Sep 09 2018 at 09:33)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133598927):
I think `leading_coeff_mul` and `leading_coeff_X_pow` should help  here,

#### [Kevin Buzzard (Sep 09 2018 at 11:26)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133601842):
The ring could even be the zero ring here! It's a particularly annoying edge case

#### [Kevin Buzzard (Sep 09 2018 at 11:34)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133602100):
...
#### [Chris Hughes (Sep 09 2018 at 12:15)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133603221):
I just generalized `leading_coeff_X_pow` to a `comm_semiring` which should help with the lemma about `leading_coeff (f * X ^ n)`.

#### [Kevin Buzzard (Sep 09 2018 at 12:44)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133604218):
...
#### [Chris Hughes (Sep 09 2018 at 12:51)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133604373):
...
#### [Reid Barton (Sep 09 2018 at 12:53)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133604414):
...
#### [Reid Barton (Sep 09 2018 at 12:53)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133604419):
Or the same for `f * X^n`.

#### [Chris Hughes (Sep 09 2018 at 12:53)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133604423):
...
#### [Chris Hughes (Sep 09 2018 at 12:55)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133604472):
...
#### [Kevin Buzzard (Sep 09 2018 at 12:57)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133604521):
@**Chris Hughes** got it -- thanks.

#### [Kenny Lau (Sep 09 2018 at 17:48)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133615540):
```lean
...
#### [Kevin Buzzard (Sep 10 2018 at 21:37)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133683986):
...
#### [Johan Commelin (Sep 10 2018 at 21:38)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133684055):
I completely agree with you that `f n` looks very ~~evil~~eval.

#### [Chris Hughes (Sep 10 2018 at 21:45)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133684380):
Maybe we should change the `has_coe_to_fun` to evaluation, and use `coeff` for coefficients.

#### [Johan Commelin (Sep 10 2018 at 21:46)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133684430):
...
#### [Johan Commelin (Sep 10 2018 at 21:46)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133684444):
In general I wouldn't mind having `coeff n f` for the `n`th coefficient of `f`.

#### [Johan Commelin (Sep 10 2018 at 21:48)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133684551):
...
#### [Kevin Buzzard (Sep 10 2018 at 21:48)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133684552):
Kenny can you prove
...
#### [Kenny Lau (Sep 10 2018 at 21:50)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133684651):
sure

#### [Kenny Lau (Sep 10 2018 at 21:50)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133684657):
in fact that's what I did at first

#### [Kenny Lau (Sep 10 2018 at 21:50)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133684658):
and then I realized that I can generalize it

#### [Kenny Lau (Sep 10 2018 at 21:50)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133684662):
and prove your theorem directly

#### [Mario Carneiro (Sep 10 2018 at 21:54)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133684862):
...
#### [Mario Carneiro (Sep 10 2018 at 21:54)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133684881):
i.e. talking about the complex roots of an integer polynomial

#### [Reid Barton (Sep 10 2018 at 21:56)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133684993):
Is there a reason not to make the coercion use `eval2` then?

#### [Johan Commelin (Sep 10 2018 at 21:57)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133684996):
...
#### [Reid Barton (Sep 10 2018 at 21:57)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133685003):
oh, you need the ring hom, I see

#### [Reid Barton (Sep 10 2018 at 21:57)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133685007):
right

#### [Reid Barton (Sep 10 2018 at 21:57)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133685024):
well, if the target ring is an algebra over the ring of definition of the polynomial...

#### [Reid Barton (Sep 10 2018 at 21:58)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133685065):
Excuse me, semialgebra

#### [Reid Barton (Sep 10 2018 at 21:59)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133685128):
...
#### [Kenny Lau (Sep 10 2018 at 22:01)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133685267):
https://leanprover.zulipchat.com/#narrow/stream/116395-maths/subject/Perfectoid.20spaces/near/133304087

#### [Kenny Lau (Sep 10 2018 at 22:01)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133685272):
[sounds like something I wrote](https://github.com/kckennylau/Lean/blob/master/polynomial.lean)

#### [Reid Barton (Sep 10 2018 at 22:06)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133685601):
`eval' R A x f` is perhaps not quite as beautiful as the `f x` I had in mind, but otherwise yes exactly this.

#### [Reid Barton (Sep 10 2018 at 22:07)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133685627):
Were there class inference problems with `R` and `A`?

#### [Kenny Lau (Sep 10 2018 at 22:21)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133686431):
I forgot

#### [Kenny Lau (Sep 10 2018 at 22:21)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133686435):
I don't know if this will cause troubles

#### [Kevin Buzzard (Sep 10 2018 at 22:30)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133687008):
...
#### [Kenny Lau (Sep 10 2018 at 22:54)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133688234):
```lean
import data.polynomial
...
#### [Kenny Lau (Sep 10 2018 at 22:54)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133688239):
400 ms

#### [Mario Carneiro (Sep 10 2018 at 22:55)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133688313):
by the way, the `try_for` is only for debugging, you don't need to leave it in finished proofs

#### [Kenny Lau (Sep 10 2018 at 22:57)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133688414):
```lean
import data.polynomial
...
#### [Kenny Lau (Sep 10 2018 at 22:57)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133688422):
300 ms, shorter and faster

#### [Kenny Lau (Sep 10 2018 at 22:57)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133688439):
(remember to remove the `try_for` when you copy)

#### [Kenny Lau (Sep 10 2018 at 23:01)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133688699):
@**Mario Carneiro** is `rw` faster or `exact` faster, in general?

#### [Mario Carneiro (Sep 10 2018 at 23:01)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133688714):
this is a silly question

#### [Mario Carneiro (Sep 10 2018 at 23:01)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133688721):
it depends on a thousand and one factors

#### [Kenny Lau (Sep 10 2018 at 23:02)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133688735):
ok, then let's be specific

#### [Kenny Lau (Sep 10 2018 at 23:02)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133688774):
```lean
import data.polynomial
...
#### [Kenny Lau (Sep 10 2018 at 23:02)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133688787):
why is this slower than the previous one?

#### [Mario Carneiro (Sep 10 2018 at 23:02)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133688793):
the answer is "try it and find out"

#### [Mario Carneiro (Sep 10 2018 at 23:03)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133688824):
...
#### [Kenny Lau (Sep 10 2018 at 23:09)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133689220):
ok seriously it can be as fast as 300 ms as long as I use `rw` instead of `refine`/`exact`

#### [Kenny Lau (Sep 10 2018 at 23:09)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133689223):
```lean
import data.polynomial
...
#### [Kenny Lau (Sep 10 2018 at 23:09)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133689228):
which is quite counter-intuitive

#### [Mario Carneiro (Sep 10 2018 at 23:11)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133689346):
I would guess the `(if_pos rfl).trans` spots are hard for the elaborator

#### [Kenny Lau (Sep 10 2018 at 23:13)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133689494):
I need to thank the elaborator some time for his hard work

#### [Reid Barton (Sep 11 2018 at 14:19)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133727884):
```quote
I don't care about the coercion to fun, I'm just concerned that we don't have a good interface for coefficients. Is there a problem with adding `coeff f n` and using it to state lemmas and making it the "official" interface to access coefficients?
```
...
#### [Kevin Buzzard (Sep 11 2018 at 14:57)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/f*X^n=0 -> f=0/near/133729846):
