...
#### [Kevin Buzzard (Aug 06 2018 at 12:21)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/↑(m * n) = ↑m * ↑n/near/130969577):
...
#### [Patrick Massot (Aug 06 2018 at 12:24)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/↑(m * n) = ↑m * ↑n/near/130969700):
...
#### [Mario Carneiro (Aug 06 2018 at 12:25)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/↑(m * n) = ↑m * ↑n/near/130969712):
...
#### [Kevin Buzzard (Aug 06 2018 at 12:26)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/↑(m * n) = ↑m * ↑n/near/130969770):
...
#### [Patrick Massot (Aug 06 2018 at 12:26)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/↑(m * n) = ↑m * ↑n/near/130969780):
yes, because Lean decided to insert a coercion too early

#### [Mario Carneiro (Aug 06 2018 at 12:27)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/↑(m * n) = ↑m * ↑n/near/130969788):
...
#### [Patrick Massot (Aug 06 2018 at 12:27)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/↑(m * n) = ↑m * ↑n/near/130969793):
in that case it's fun, but in my case I don't have a multiplication on the bigger space

#### [Mario Carneiro (Aug 06 2018 at 12:27)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/↑(m * n) = ↑m * ↑n/near/130969799):
you can avoid double ascription by putting up arrows in the appropriate places

#### [Mario Carneiro (Aug 06 2018 at 12:28)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/↑(m * n) = ↑m * ↑n/near/130969854):
```
example (x y : ℚ) : (↑(x * y) : ℝ) = ↑x * ↑y := by simp
```

#### [Mario Carneiro (Aug 06 2018 at 12:28)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/↑(m * n) = ↑m * ↑n/near/130969871):
(the up arrows on the right are optional)

#### [Guy Leroy (Aug 06 2018 at 12:30)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/↑(m * n) = ↑m * ↑n/near/130969961):
If the goal has arrows, is there a set_option to see the source and target of the coercion?

#### [Kenny Lau (Aug 06 2018 at 12:30)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/↑(m * n) = ↑m * ↑n/near/130969969):
`set_option pp.all true`

#### [Mario Carneiro (Aug 06 2018 at 12:31)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/↑(m * n) = ↑m * ↑n/near/130969985):
...
#### [Mario Carneiro (Aug 06 2018 at 12:31)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/↑(m * n) = ↑m * ↑n/near/130969993):
or `pp.all true` which shows even more irrelevant info

#### [Guy Leroy (Aug 06 2018 at 12:31)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/↑(m * n) = ↑m * ↑n/near/130969995):
Okay thanks

#### [Kevin Buzzard (Aug 06 2018 at 12:36)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/↑(m * n) = ↑m * ↑n/near/130970238):
...
#### [Kenny Lau (Aug 06 2018 at 12:37)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/↑(m * n) = ↑m * ↑n/near/130970261):
you need `set_option pp.universe true` for even more information right

#### [Mario Carneiro (Aug 06 2018 at 12:37)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/↑(m * n) = ↑m * ↑n/near/130970264):
...
#### [Kevin Buzzard (Aug 06 2018 at 12:39)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/↑(m * n) = ↑m * ↑n/near/130970364):
```quote
`example (x y : ℚ) : (↑(x * y) : ℝ) = ↑x * ↑y := by simp`
```
What is going on here? Why is that not the same as ` ((x * y) : ℝ)`? There's something simple I'm missing.

#### [Mario Carneiro (Aug 06 2018 at 12:41)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/↑(m * n) = ↑m * ↑n/near/130970460):
