...
#### [Kevin Buzzard (Sep 06 2018 at 00:13)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Is mathlib broken currently? (no)/near/133406331):
```lean
...
#### [Kevin Buzzard (Sep 06 2018 at 00:14)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Is mathlib broken currently? (no)/near/133406390):
hmm on the other hand I just managed to compile mathlib master so I don't know what's going on.

#### [Kevin Buzzard (Sep 06 2018 at 00:15)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Is mathlib broken currently? (no)/near/133406443):
It's the coercion from finset beta to set beta which seems to cause the loop

#### [Johannes Hölzl (Sep 06 2018 at 00:53)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Is mathlib broken currently? (no)/near/133408030):
`(2) ?x_7 : has_coe (finset β) ?x_5 := @quotient_ring.has_coe ?x_9 ?x_10 ?x_11 ?x_12`
ouch, doesn't seam to be a good coercion rule...

#### [Johannes Hölzl (Sep 06 2018 at 01:01)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Is mathlib broken currently? (no)/near/133408329):
not this one but the `quotient_module` one

#### [Johannes Hölzl (Sep 06 2018 at 01:04)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Is mathlib broken currently? (no)/near/133408472):
it should work now

#### [Mario Carneiro (Sep 06 2018 at 01:20)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Is mathlib broken currently? (no)/near/133409247):
...
#### [Johannes Hölzl (Sep 06 2018 at 01:23)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Is mathlib broken currently? (no)/near/133409438):
hm, then it needs to be changed further. I just fixed the implicit instead of instance for the out_param problem.

#### [Kevin Buzzard (Sep 06 2018 at 08:47)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Is mathlib broken currently? (no)/near/133425189):
...
#### [Kevin Buzzard (Sep 06 2018 at 11:03)](https://leanprover.zulipchat.com/#narrow/stream/116395-maths/topic/Is mathlib broken currently? (no)/near/133430208):
