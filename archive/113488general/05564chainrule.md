...
#### [![Click to go to Zulip](../../assets/img/zulip2.png) Patrick Massot (Feb 28 2018 at 14:55)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123090492):
What is the miracle here? Is it proving stuff about o and O notations?

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Chris Hughes (Feb 28 2018 at 19:55)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123102048):
...
#### [![Click to go to Zulip](../../assets/img/zulip2.png) Mario Carneiro (Feb 28 2018 at 20:01)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123102296):
...
#### [![Click to go to Zulip](../../assets/img/zulip2.png) Patrick Massot (Feb 28 2018 at 21:35)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123106492):
I understand that some stuff is split into several lemmas, but it still doesn't seem to be 100 lines long

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Simon Hudon (Feb 28 2018 at 21:40)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123106699):
...
#### [![Click to go to Zulip](../../assets/img/zulip2.png) Patrick Massot (Feb 28 2018 at 21:44)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123106851):
...
#### [![Click to go to Zulip](../../assets/img/zulip2.png) Damien Rouhling (Mar 01 2018 at 10:04)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123129650):
Hello everyone.
...
#### [![Click to go to Zulip](../../assets/img/zulip2.png) Patrick Massot (Mar 01 2018 at 10:06)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123129709):
...
#### [![Click to go to Zulip](../../assets/img/zulip2.png) Patrick Massot (Mar 01 2018 at 10:07)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123129724):
...
#### [![Click to go to Zulip](../../assets/img/zulip2.png) Patrick Massot (Mar 01 2018 at 10:08)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123129773):
...
#### [![Click to go to Zulip](../../assets/img/zulip2.png) Patrick Massot (Mar 01 2018 at 10:09)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123129778):
Can you do computations with o and O floating around in the middle of formulas?

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Patrick Massot (Mar 01 2018 at 10:09)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123129781):
Or only state as an hypothesis or conclusion that f = o(g)?

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Damien Rouhling (Mar 01 2018 at 10:11)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123129845):
We have rewriting rules for o and O so we can indeed manipulate such expressions.

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Patrick Massot (Mar 01 2018 at 10:12)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123129853):
...
#### [![Click to go to Zulip](../../assets/img/zulip2.png) Damien Rouhling (Mar 01 2018 at 10:24)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123130268):
...
#### [![Click to go to Zulip](../../assets/img/zulip2.png) Cyril Cohen (Mar 01 2018 at 10:26)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123130338):
We have a draft paper here about this: https://hal.inria.fr/hal-01719918

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Patrick Massot (Mar 01 2018 at 14:37)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123138004):
Nice! :heart_eyes: @**Mario Carneiro** please, please, please, can we have this little-o and big-O magic in mathlib?

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Patrick Massot (Mar 01 2018 at 14:39)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123138057):
...
#### [![Click to go to Zulip](../../assets/img/zulip2.png) Patrick Massot (Mar 01 2018 at 14:41)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123138123):
Where is Johannes? It seems he didn't come from Gitter to here. He should see this.

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Cyril Cohen (Mar 01 2018 at 14:43)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123138178):
@**Patrick Massot** in this case Coq notations are not "blocking" because we hack around the shortcommings.

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Cyril Cohen (Mar 01 2018 at 14:46)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123138281):
...
#### [![Click to go to Zulip](../../assets/img/zulip2.png) Patrick Massot (Mar 01 2018 at 14:46)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123138282):
I think you are so much used to SSReflect notations that can't see how weird they look

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Patrick Massot (Mar 01 2018 at 14:46)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123138287):
Have you seen the `calc` blocks in my proof? This looks like mathematics to a mathematician eyes

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Patrick Massot (Mar 01 2018 at 14:47)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123138299):
...
#### [![Click to go to Zulip](../../assets/img/zulip2.png) Patrick Massot (Mar 01 2018 at 14:49)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123138357):
...
#### [![Click to go to Zulip](../../assets/img/zulip2.png) Cyril Cohen (Mar 01 2018 at 14:51)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123138439):
...
#### [![Click to go to Zulip](../../assets/img/zulip2.png) Patrick Massot (Mar 01 2018 at 14:52)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123138479):
But `@^~_ @ F` from line 38 of your paper...

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Cyril Cohen (Mar 01 2018 at 14:54)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123138515):
```quote
https://github.com/PatrickMassot/lean-differential-topology/blob/master/src/calculus.lean#L41 and https://github.com/PatrickMassot/lean-differential-topology/blob/master/src/continuous_linear_maps.lean#L129 completely kill the illusion of being doing maths
```
I am happy to hear you say this, and this is exactly the point of the above mentioned code and paper.

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Patrick Massot (Mar 01 2018 at 14:54)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123138565):
Yes I understand, here my :heart_eyes: reaction

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Cyril Cohen (Mar 01 2018 at 14:57)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123138657):
```quote
But `@^~_ @ F` from line 38 of your paper...
```
...looks cryptic... I realize that now. Is it that bad?

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Sebastian Ullrich (Mar 01 2018 at 14:58)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123138704):
I didn't know you could embed Perl into Coq!

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Cyril Cohen (Mar 01 2018 at 14:58)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123138707):
bad -> difficult to read

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Moses Schönfinkel (Mar 01 2018 at 14:59)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123138717):
Be careful what you say around Coq people. Next thing you know there's "Cerl" or "Peroq".

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Patrick Massot (Mar 01 2018 at 14:59)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123138728):
In Lean you could write "bad → difficult to read". Unicode symbols is the default option

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Patrick Massot (Mar 01 2018 at 15:00)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123138734):
No ascii art notation

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Patrick Massot (Mar 01 2018 at 15:01)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123138806):
```quote
...looks cryptic... I realize that now. Is it that bad?
```
It's not much worse than `g => /=.`

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Patrick Massot (Mar 01 2018 at 15:04)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123138952):
...
#### [![Click to go to Zulip](../../assets/img/zulip2.png) Patrick Massot (Mar 01 2018 at 15:05)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123138979):
And my kids need me again (nap time ended), sorry

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Cyril Cohen (Mar 01 2018 at 15:05)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123138982):
I can totally agree with your last remark.

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Patrick Massot (Mar 01 2018 at 15:07)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123139061):
...
#### [![Click to go to Zulip](../../assets/img/zulip2.png) Cyril Cohen (Mar 01 2018 at 15:07)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123139065):
...
#### [![Click to go to Zulip](../../assets/img/zulip2.png) Patrick Massot (Mar 01 2018 at 15:08)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123139131):
...
#### [![Click to go to Zulip](../../assets/img/zulip2.png) Patrick Massot (Mar 01 2018 at 15:09)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123139140):
And now I really have to go. See you!

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Cyril Cohen (Mar 01 2018 at 15:09)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123139142):
...
#### [![Click to go to Zulip](../../assets/img/zulip2.png) Cyril Cohen (Mar 01 2018 at 15:09)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123139144):
@**Patrick Massot** see you later

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Moses Schönfinkel (Mar 01 2018 at 15:09)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123139145):
...
#### [![Click to go to Zulip](../../assets/img/zulip2.png) Johannes Hölzl (Mar 02 2018 at 12:57)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123180953):
...
#### [![Click to go to Zulip](../../assets/img/zulip2.png) Patrick Massot (Mar 02 2018 at 12:58)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123180990):
Would it be an awful lot of work to adapt this to Lean and have them in mathlib?

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Johannes Hölzl (Mar 02 2018 at 13:01)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123181067):
...
#### [![Click to go to Zulip](../../assets/img/zulip2.png) Cyril Cohen (Mar 02 2018 at 13:54)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123182527):
```quote
Cyril showed me the `near` tactics at the TYPES meeting in Nijmegen a month ago. And indeed, they looks very nice! Modulo ssreflect which I still can't read :)
```
...
#### [![Click to go to Zulip](../../assets/img/zulip2.png) Johannes Hölzl (Mar 02 2018 at 13:55)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123182544):
Oh yes, it's on my list!

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Patrick Massot (Mar 02 2018 at 13:55)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123182545):
Great!

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Patrick Massot (Mar 05 2018 at 21:47)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123317833):
@**Johannes Hölzl** is today's filter commit related to the discussion in this topic?

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Johannes Hölzl (Mar 05 2018 at 21:52)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/chain%20rule/near/123318060):
