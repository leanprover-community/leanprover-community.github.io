...
#### [Kevin Buzzard (Nov 18 2018 at 16:43)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/(¬ Q → ¬ P) → (P → Q)/near/147920972):
gaargh I can't find
...
#### [petercommand (Nov 18 2018 at 17:19)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/(¬ Q → ¬ P) → (P → Q)/near/147921971):
how do you use #find? #find doesn't work for me at all..

#### [Mario Carneiro (Nov 18 2018 at 17:31)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/(¬ Q → ¬ P) → (P → Q)/near/147922311):
you have to import `tactic.find`

#### [Mario Carneiro (Nov 18 2018 at 17:32)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/(¬ Q → ¬ P) → (P → Q)/near/147922361):
of course this is going to be in `logic.basic`

#### [Mario Carneiro (Nov 18 2018 at 17:32)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/(¬ Q → ¬ P) → (P → Q)/near/147922362):
looks like it is `not_imp_not`

#### [Mario Carneiro (Nov 18 2018 at 17:33)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/(¬ Q → ¬ P) → (P → Q)/near/147922369):
it's a biconditional, which is why find didn't find it the way you stated it

#### [Mario Carneiro (Nov 18 2018 at 17:34)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/(¬ Q → ¬ P) → (P → Q)/near/147922376):
it's not classical.something because it has a decidability assumption

#### [Kevin Buzzard (Nov 18 2018 at 20:38)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/(¬ Q → ¬ P) → (P → Q)/near/147927996):
