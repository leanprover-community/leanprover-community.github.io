...
#### [Nima (Apr 21 2018 at 09:51)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/cases fails on exists/near/125485520):
...
#### [Mario Carneiro (Apr 21 2018 at 09:55)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/cases fails on exists/near/125485620):
...
#### [Nima (Apr 21 2018 at 10:01)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/cases fails on exists/near/125485757):
...
#### [Mario Carneiro (Apr 21 2018 at 10:01)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/cases fails on exists/near/125485763):
You can use cases on exists to prove a Prop, but not to construct data (something in a type that lives in Type)

#### [Mario Carneiro (Apr 21 2018 at 10:02)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/cases fails on exists/near/125485803):
here it's okay because `false : Prop`

#### [Mario Carneiro (Apr 21 2018 at 10:02)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/cases fails on exists/near/125485804):
while in the other case `α : Type u_1 != Prop`

#### [Mario Carneiro (Apr 21 2018 at 10:04)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/cases fails on exists/near/125485850):
...
#### [Nima (Apr 21 2018 at 10:04)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/cases fails on exists/near/125485851):
Are you pointing to the `α` that is used in the goal?

#### [Mario Carneiro (Apr 21 2018 at 10:04)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/cases fails on exists/near/125485852):
yes

#### [Mario Carneiro (Apr 21 2018 at 10:04)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/cases fails on exists/near/125485854):
why are you "proving" alpha?

#### [Mario Carneiro (Apr 21 2018 at 10:05)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/cases fails on exists/near/125485861):
...
#### [Nima (Apr 21 2018 at 10:05)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/cases fails on exists/near/125485862):
It is supposed to be a function, not a proof.
I find it easier to go into tactic mode.

#### [Mario Carneiro (Apr 21 2018 at 10:07)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/cases fails on exists/near/125485904):
You want to be careful about the dependency structure that the tactic creates

#### [Nima (Apr 21 2018 at 10:08)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/cases fails on exists/near/125485948):
...
#### [Mario Carneiro (Apr 21 2018 at 10:08)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/cases fails on exists/near/125485950):
...
#### [Mario Carneiro (Apr 21 2018 at 10:11)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/cases fails on exists/near/125485998):
...
#### [Mario Carneiro (Apr 21 2018 at 10:16)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/cases fails on exists/near/125486151):
...
#### [Nima (Apr 21 2018 at 10:21)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/cases fails on exists/near/125486261):
Nope, I have to look into `roption`.

#### [Mario Carneiro (Apr 21 2018 at 10:36)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/cases fails on exists/near/125486627):
...
#### [Nima (Apr 21 2018 at 10:50)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/cases fails on exists/near/125486992):
Not sure, practice ;) or avoiding coe as much as possible

#### [Mario Carneiro (Apr 21 2018 at 11:03)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/cases fails on exists/near/125487285):
...
#### [Nima (Apr 21 2018 at 11:10)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/cases fails on exists/near/125487469):
...
#### [Mario Carneiro (Apr 21 2018 at 11:13)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/cases fails on exists/near/125487513):
when will knowing `has_inf` make computation of `inf` faster?

#### [Mario Carneiro (Apr 21 2018 at 11:14)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/cases fails on exists/near/125487560):
...
#### [Nima (Apr 21 2018 at 11:15)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/cases fails on exists/near/125487566):
...
#### [Mario Carneiro (Apr 21 2018 at 11:16)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/cases fails on exists/near/125487609):
or you could do it in two stages with a `bool` function:
```
(has_min : bool) (has_min_prop : has_min = min.is_some)
```

#### [Mario Carneiro (Apr 21 2018 at 11:17)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/cases fails on exists/near/125487614):
that way it won't interfere with the definition of `min` or `inf` or whatever

#### [Nima (Apr 21 2018 at 11:17)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/cases fails on exists/near/125487615):
...
#### [Mario Carneiro (Apr 21 2018 at 11:19)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/cases fails on exists/near/125487665):
...
#### [Nima (Apr 21 2018 at 11:20)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/cases fails on exists/near/125487708):
Are you talking about `(h: has_inf c)` as a parameter to `inf`?

#### [Mario Carneiro (Apr 21 2018 at 11:20)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/cases fails on exists/near/125487709):
yes

#### [Mario Carneiro (Apr 21 2018 at 11:20)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/cases fails on exists/near/125487714):
How do you intend to relate the lean code you are writing to C++? This affects performance considerations

#### [Mario Carneiro (Apr 21 2018 at 11:21)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/cases fails on exists/near/125487721):
Is this code to be `#eval`d? Compiled to C++ and then run? Used only for correctness verification?

#### [Nima (Apr 21 2018 at 11:27)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/cases fails on exists/near/125487859):
