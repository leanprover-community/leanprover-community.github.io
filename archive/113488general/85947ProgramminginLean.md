...
#### [Chris Hughes (Jul 11 2018 at 13:20)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129464604):
...
#### [Simon Hudon (Jul 11 2018 at 13:49)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129465591):
...
#### [Simon Hudon (Jul 11 2018 at 13:50)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129465655):
...
#### [Chris Hughes (Jul 11 2018 at 13:52)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129465732):
It doesn't quite work. It complains lemmas has type `list expr` but needs to have type `simp_lemmas`

#### [Chris Hughes (Jul 11 2018 at 13:53)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129465747):
I'm a bit confused about the type `simp_lemmas`. It's defined as a constant, which seems a bit odd to me.

#### [Mario Carneiro (Jul 11 2018 at 13:54)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129465798):
it's a special cached representation of a simp set

#### [Mario Carneiro (Jul 11 2018 at 13:54)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129465801):
you should use the `simp_lemmas` functions to construct one

#### [Chris Hughes (Jul 11 2018 at 13:55)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129465810):
So it looks almost like an inductive type, but they made all the constructors constants for some reason.

#### [Chris Hughes (Jul 11 2018 at 13:55)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129465815):
I'll see if I can fix the list myself.

#### [Simon Hudon (Jul 11 2018 at 13:56)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129465842):
`simp_lemmas.append` and `simp_lemmas.mk` should be sufficient

#### [Simon Hudon (Jul 11 2018 at 13:57)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129465874):
```lean
meta def normalize_hyps : tactic unit :=
do hyps ← local_context,
lemmas ← list.mmap mk_const [``iff_iff_implies_and_implies,
...
#### [Simon Hudon (Jul 11 2018 at 13:57)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129465882):
... and adjust `normalize_hyp` accordingly ;-)

#### [Kevin Buzzard (Jul 11 2018 at 14:11)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129466489):
...
#### [Chris Hughes (Jul 11 2018 at 14:15)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129466694):
How does the notation with the backticks and brackets work? What's the difference between `'x`, `'''x`, `'''x`, `'(x)`, `''(x) and `'''(x)`?

#### [Mario Carneiro (Jul 11 2018 at 14:35)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129467739):
...
#### [Chris Hughes (Jul 11 2018 at 14:53)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129468544):
So can I give ` ''(my pexpr)` when an `expr` is expected and it will elaborate it into an `expr` at parse time?

#### [Simon Hudon (Jul 11 2018 at 14:58)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129468811):
About back ticks and quoting them: you can include them ``` `` `(foo) `` ``` by using one more backtick to quote what's inside

#### [Simon Hudon (Jul 11 2018 at 14:59)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129468833):
And I produced the above by writing  ```` ``` `` `(foo) `` ``` ````

#### [Mario Carneiro (Jul 11 2018 at 15:01)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129468922):
...
#### [Sebastien Gouezel (Jul 11 2018 at 15:47)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129471102):
...
#### [Mario Carneiro (Jul 11 2018 at 15:51)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129471295):
...
#### [Chris Hughes (Jul 11 2018 at 15:52)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129471423):
What is `%%`? I couldn't find it in programming in lean.

#### [Mario Carneiro (Jul 11 2018 at 15:53)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129471498):
...
#### [Chris Hughes (Jul 11 2018 at 15:54)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129471551):
are `` ` `` and `%%` notation for some function or some deeper inbuilt thing?

#### [Mario Carneiro (Jul 11 2018 at 15:54)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129471568):
a bit of both

#### [Mario Carneiro (Jul 11 2018 at 15:55)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129471589):
...
#### [Chris Hughes (Jul 11 2018 at 15:55)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129471593):
so `%%` turns an `expr` into the thing that the `expr` represents, like a `real` or a `nat` or something?

#### [Mario Carneiro (Jul 11 2018 at 15:56)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129471638):
You can always just write it down and then inspect the resulting tactic with `#print` to find out how the sausage is made

#### [Mario Carneiro (Jul 11 2018 at 15:56)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129471654):
No, `%%` inserts the `expr` into a hole in another `expr` you are creating

#### [Mario Carneiro (Jul 11 2018 at 15:57)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129471681):
For example, if `a b : expr` then `` `(%%a + %%b)`` is of type `expr`

#### [Mario Carneiro (Jul 11 2018 at 15:58)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129471748):
...
#### [Mario Carneiro (Jul 11 2018 at 16:01)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129471969):
...
#### [Mario Carneiro (Jul 11 2018 at 16:03)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129472100):
...
#### [Chris Hughes (Jul 11 2018 at 16:11)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129472732):
so when you say `` `(my expr)  ``, `my expr` is not an object of type `expr` it's an actual expression like `` `(2 + 2) ``

#### [Mario Carneiro (Jul 11 2018 at 16:14)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129472907):
right

#### [Chris Hughes (Jul 11 2018 at 18:26)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129482162):
...
#### [Sebastian Ullrich (Jul 11 2018 at 18:43)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129483237):
...
#### [Chris Hughes (Jul 11 2018 at 18:52)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129483792):
Thanks.

#### [Chris Hughes (Jul 13 2018 at 17:39)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129608241):
...
#### [Sebastian Ullrich (Jul 13 2018 at 17:45)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129608635):
Also section 6 :)

#### [Kevin Buzzard (Jul 13 2018 at 19:19)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129614422):
...
#### [Simon Hudon (Jul 13 2018 at 19:33)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129615276):
I think officially, `begin x end` is shorthand for `by { x }`

#### [Chris Hughes (Jul 14 2018 at 11:21)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129654459):
...
#### [Patrick Massot (Jul 14 2018 at 11:27)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129654705):
Aren't they default values for these fields?

#### [Chris Hughes (Jul 14 2018 at 11:38)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129655071):
I thought that's what they probably were, but I wasn't sure.

#### [Patrick Massot (Jul 14 2018 at 11:39)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129655083):
see https://leanprover.github.io/reference/declarations.html#structures-and-records

#### [Patrick Massot (Jul 14 2018 at 11:40)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129655118):
> Lean also allows you to specify a default value for any field in a structure by writing (fieldᵢ : βᵢ := t).

#### [Kevin Buzzard (Jul 14 2018 at 13:04)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129657371):
...
#### [Chris Hughes (Jul 14 2018 at 14:04)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129659353):
...
#### [Mario Carneiro (Jul 14 2018 at 14:20)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129659882):
It's not an inductive type

#### [Mario Carneiro (Jul 14 2018 at 14:20)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129659925):
that's why there are no eliminators

#### [Mario Carneiro (Jul 14 2018 at 14:21)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129659944):
The reason it's all meta constants is, as you say, that it is interfacing with C++

#### [Mario Carneiro (Jul 14 2018 at 14:21)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129659946):
these are all just hooks to C++ functions

#### [Mario Carneiro (Jul 14 2018 at 14:26)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Programming in Lean/near/129660104):
