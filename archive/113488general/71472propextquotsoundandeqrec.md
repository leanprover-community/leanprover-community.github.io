...
#### [Chris Hughes (Oct 09 2018 at 13:44)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/propext, quot.sound and eq.rec/near/135462261):
Is every `nat` defined using `propext`, `quot.sound` and `eq.rec` but without choice guaranteed to reduce to `succ $ succ $ succ ... zero`?

#### [Gabriel Ebner (Oct 09 2018 at 18:19)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/propext, quot.sound and eq.rec/near/135481037):
...
#### [Gabriel Ebner (Oct 09 2018 at 18:20)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/propext, quot.sound and eq.rec/near/135481110):
...
#### [Kevin Buzzard (Oct 09 2018 at 18:27)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/propext, quot.sound and eq.rec/near/135481440):
An excellent question and an excellent answer!

#### [Scott Olson (Oct 09 2018 at 18:30)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/propext, quot.sound and eq.rec/near/135481619):
...
#### [Chris Hughes (Oct 09 2018 at 18:38)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/propext, quot.sound and eq.rec/near/135482021):
...
#### [Chris Hughes (Oct 09 2018 at 18:40)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/propext, quot.sound and eq.rec/near/135482155):
This basically means that a lot of computable functions aren't really computable. That is surprising.

#### [Scott Olson (Oct 09 2018 at 18:45)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/propext, quot.sound and eq.rec/near/135482382):
...
#### [Scott Olson (Oct 09 2018 at 18:47)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/propext, quot.sound and eq.rec/near/135482525):
...
#### [Gabriel Ebner (Oct 09 2018 at 18:47)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/propext, quot.sound and eq.rec/near/135482544):
```quote
...
#### [Mario Carneiro (Oct 09 2018 at 21:56)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/propext, quot.sound and eq.rec/near/135494239):
...
#### [Mario Carneiro (Oct 09 2018 at 21:58)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/propext, quot.sound and eq.rec/near/135494367):
...
#### [Chris Hughes (Oct 13 2018 at 00:56)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/propext, quot.sound and eq.rec/near/135706032):
```quote
I'm pretty sure @**Mario Carneiro** has an example lying around that doesn't even need `propext`; I think you can do this even with a counterexample to the transitivity of definitional equality.
```
...
#### [Kenny Lau (Oct 13 2018 at 01:08)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/propext, quot.sound and eq.rec/near/135706590):
...
#### [Kenny Lau (Oct 13 2018 at 01:09)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/propext, quot.sound and eq.rec/near/135706602):
@**Mario Carneiro** what is `pack` and `unpack` and `primitive` and are there any more hidden constructors like this?

#### [Mario Carneiro (Oct 13 2018 at 04:13)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/propext, quot.sound and eq.rec/near/135712980):
...
#### [Mario Carneiro (Oct 13 2018 at 04:17)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/propext, quot.sound and eq.rec/near/135713102):
...
#### [Mario Carneiro (Oct 13 2018 at 04:36)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/propext, quot.sound and eq.rec/near/135713753):
...
#### [Mario Carneiro (Oct 13 2018 at 04:39)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/propext, quot.sound and eq.rec/near/135713821):
...
#### [Kevin Buzzard (Oct 13 2018 at 08:49)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/propext, quot.sound and eq.rec/near/135720885):
```quote
...
#### [Mario Carneiro (Oct 13 2018 at 08:56)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/propext, quot.sound and eq.rec/near/135721078):
...
#### [Mario Carneiro (Oct 13 2018 at 08:57)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/propext, quot.sound and eq.rec/near/135721090):
nested inductive translation seems kind of overcomplicated

#### [Kenny Lau (Oct 13 2018 at 09:48)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/propext, quot.sound and eq.rec/near/135722421):
```lean
inductive bad : Type
| bad : list bad → bad
...
#### [Mario Carneiro (Oct 13 2018 at 09:52)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/propext, quot.sound and eq.rec/near/135722527):
...
#### [Mario Carneiro (Oct 13 2018 at 09:52)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/propext, quot.sound and eq.rec/near/135722530):
this is one of the reasons equation lemmas are a thing

#### [Kenny Lau (Oct 13 2018 at 09:53)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/propext, quot.sound and eq.rec/near/135722531):
what does canonicity mean?

#### [Mario Carneiro (Oct 13 2018 at 09:54)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/propext, quot.sound and eq.rec/near/135722577):
...
#### [Mario Carneiro (Oct 13 2018 at 09:54)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/propext, quot.sound and eq.rec/near/135722580):
i.e. for nat this means `succ $ ... $ 0`

#### [Kenny Lau (Oct 13 2018 at 09:54)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/propext, quot.sound and eq.rec/near/135722584):
but this error I found, it doesn't affect canonicity?

#### [Mario Carneiro (Oct 13 2018 at 09:55)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/propext, quot.sound and eq.rec/near/135722596):
no because nothing there is an axiomatic constant

#### [Mario Carneiro (Oct 13 2018 at 09:55)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/propext, quot.sound and eq.rec/near/135722603):
it's all a layer over the real inductive type

#### [Mario Carneiro (Oct 13 2018 at 09:55)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/propext, quot.sound and eq.rec/near/135722605):
That theorem has to be proven by cases or induction or something internally so it's not defeq

#### [Kevin Buzzard (Oct 13 2018 at 10:02)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/propext, quot.sound and eq.rec/near/135722841):
...
#### [Mario Carneiro (Oct 13 2018 at 10:02)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/propext, quot.sound and eq.rec/near/135722854):
yes

#### [Mario Carneiro (Oct 13 2018 at 10:02)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/propext, quot.sound and eq.rec/near/135722855):
except in this case lean did it all for you and slapped a nice API over the whole thing

#### [Mario Carneiro (Oct 13 2018 at 10:03)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/propext, quot.sound and eq.rec/near/135722865):
...
#### [Kenny Lau (Oct 13 2018 at 10:07)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/propext, quot.sound and eq.rec/near/135722965):
```lean
inductive bad : Type
| bad : list bad → bad
...
#### [Mario Carneiro (Oct 13 2018 at 10:10)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/propext, quot.sound and eq.rec/near/135723063):
this is just a funny way of writing `bad.to_list.equations._eqn_1 L` of course

#### [Gabriel Ebner (Oct 13 2018 at 11:33)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/propext, quot.sound and eq.rec/near/135725329):
