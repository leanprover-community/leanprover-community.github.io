...
#### [Kevin Buzzard (Aug 12 2018 at 13:48)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131994333):
```lean
...
#### [Mario Carneiro (Aug 12 2018 at 13:57)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131994536):
You are doing the job of the kernel here, which is unfortunately not so verbose when it does things

#### [Mario Carneiro (Aug 12 2018 at 13:59)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131994590):
...
#### [Kevin Buzzard (Aug 12 2018 at 14:03)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131994704):
...
#### [Mario Carneiro (Aug 12 2018 at 14:03)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131994706):
It is a defeq "goal"

#### [Kenny Lau (Aug 12 2018 at 14:03)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131994709):
so a sort of unification, I guess

#### [Kevin Buzzard (Aug 12 2018 at 14:04)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131994748):
...
#### [Mario Carneiro (Aug 12 2018 at 14:04)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131994751):
yes, it is used in unification and also pure defeq checking

#### [Mario Carneiro (Aug 12 2018 at 14:04)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131994758):
...
#### [Kevin Buzzard (Aug 12 2018 at 14:05)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131994760):
Right, I think I've also seen it in the context `?m_1 =?= nat` with metavariables. That's the same usage?

#### [Mario Carneiro (Aug 12 2018 at 14:05)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131994771):
yes

#### [Kevin Buzzard (Aug 12 2018 at 14:05)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131994773):
So at any stage in time, does Lean have a list of `A =?= B` goals?

#### [Mario Carneiro (Aug 12 2018 at 14:07)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131994827):
...
#### [Kevin Buzzard (Aug 12 2018 at 14:11)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131994964):
```lean
...
#### [Mario Carneiro (Aug 12 2018 at 14:12)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131995011):
...
#### [Mario Carneiro (Aug 12 2018 at 14:13)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131995021):
Those constants are written in C++; they hook into the elaborator code for defeq and unification

#### [Mario Carneiro (Aug 12 2018 at 14:15)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131995076):
...
#### [Mario Carneiro (Aug 12 2018 at 14:17)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131995164):
...
#### [Kevin Buzzard (Aug 12 2018 at 14:18)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131995218):
...
#### [Mario Carneiro (Aug 12 2018 at 14:19)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131995229):
`eq` has *type* `Π {α : Sort u}, α → α → Prop` but it has no *definition*

#### [Mario Carneiro (Aug 12 2018 at 14:20)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131995283):
similarly `nat.zero : nat` but `nat.zero :=` nothing

#### [Mario Carneiro (Aug 12 2018 at 14:21)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131995306):
...
#### [Kevin Buzzard (Aug 12 2018 at 14:21)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131995321):
Yes, inductive types I'm completely happy with.

#### [Kevin Buzzard (Aug 12 2018 at 14:22)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131995326):
I see. `#print eq` and `#print nat.zero` both return answers with no `:=` in

#### [Mario Carneiro (Aug 12 2018 at 14:22)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131995369):
the important part is that this is a way to introduce constants that have no definition

#### [Mario Carneiro (Aug 12 2018 at 14:22)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131995373):
all constants are either axiomatic from an inductive, declared via `axiom` or `constant`, or are definitions

#### [Mario Carneiro (Aug 12 2018 at 14:23)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131995382):
or are `quot`, `quot.mk`, `quot.lift` or `quot.sound` which are special

#### [Kevin Buzzard (Aug 12 2018 at 14:23)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131995385):
So the type, the constructors and the recursor for an inductive type are all constants?

#### [Mario Carneiro (Aug 12 2018 at 14:23)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131995389):
yes

#### [Mario Carneiro (Aug 12 2018 at 14:24)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131995442):
Above I pretended that the projection of a structure is also a constant, but I'm not sure if lean unfolds that too

#### [Kevin Buzzard (Aug 12 2018 at 14:24)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131995451):
I'm happy with the explanation that "it's iota reduction"

#### [Mario Carneiro (Aug 12 2018 at 14:25)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131995462):
...
#### [Kevin Buzzard (Aug 12 2018 at 14:26)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131995505):
`#print has_zero.zero` seems to give out some sort of junk answer -- it has no content somehow

#### [Mario Carneiro (Aug 12 2018 at 14:26)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131995507):
`has_zero.zero` is apparently defined in terms of a macro, also called `has_zero.zero`

#### [Kevin Buzzard (Aug 12 2018 at 14:27)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131995517):
Oh so that's a different `has_zero.zero` in the output?

#### [Kenny Lau (Aug 12 2018 at 14:27)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131995518):
so basically `eq` is a constant and `eq a a` for every `a` is an axiom

#### [Kevin Buzzard (Aug 12 2018 at 14:28)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131995557):
`eq a a` is a proposition and I know a way of constructing a term of that type

#### [Kenny Lau (Aug 12 2018 at 14:29)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131995559):
ok

#### [Mario Carneiro (Aug 12 2018 at 14:35)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131995739):
...
#### [Mario Carneiro (Aug 12 2018 at 14:36)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131995789):
I am sure there is a function for opening the lambdas there at the beginning, but I've forgotten what it is

#### [Kevin Buzzard (Aug 12 2018 at 14:54)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131996289):
...
#### [Mario Carneiro (Aug 12 2018 at 14:57)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131996368):
the key step there is `whnf`

#### [Mario Carneiro (Aug 12 2018 at 14:57)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131996373):
which will unfold a term until it hits a constructor, a pi, or other constant at head position

#### [Mario Carneiro (Aug 12 2018 at 14:58)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131996413):
the name means "weak head normal form"

#### [Kevin Buzzard (Aug 12 2018 at 15:07)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131996658):
```lean
definition xena.zero : ℕ := 0 
...
#### [Mario Carneiro (Aug 12 2018 at 15:08)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131996713):
that's what the first lines are for

#### [Mario Carneiro (Aug 12 2018 at 15:09)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131996726):
`get_decl` gets a declaration, from which you can get the value with `d.value`

#### [Mario Carneiro (Aug 12 2018 at 15:10)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131996786):
```lean
open tactic
run_cmd do
...
#### [Mario Carneiro (Aug 12 2018 at 15:12)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131996842):
...
#### [Mario Carneiro (Aug 12 2018 at 15:12)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131996843):
``whnf `(xena.zero) >>= trace`` also works

#### [Kevin Buzzard (Aug 12 2018 at 15:13)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131996853):
I don't see `nat.zero` -- I just see `0`. This is the pretty printer folding stuff up again, I guess?

#### [Mario Carneiro (Aug 12 2018 at 15:13)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131996855):
I have `pp.all` enabled

#### [Kevin Buzzard (Aug 12 2018 at 15:13)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131996856):
got it -- so have I now

#### [Mario Carneiro (Aug 12 2018 at 15:14)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131996901):
...
#### [Kevin Buzzard (Aug 12 2018 at 15:14)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131996904):
So it's all happening too fast -- `whnf` turns `xena.zero` straight into `nat.zero` like `#reduce`?

#### [Mario Carneiro (Aug 12 2018 at 15:15)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131996916):
right, `whnf` unfolds definitions until it reaches something which isn't a definition

#### [Mario Carneiro (Aug 12 2018 at 15:15)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131996926):
it is similar to `#reduce`, but it doesn't reduce everything, only stuff at the head

#### [Mario Carneiro (Aug 12 2018 at 15:16)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131996972):
for example:
```lean
run_cmd whnf `(λ x : ℕ, xena.zero) >>= trace -- λ (x : nat), xena.zero
```

#### [Kevin Buzzard (Aug 12 2018 at 15:17)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131996982):
`d.value` seems to have type `expr bool.tt`. What's that bool doing there?

#### [Mario Carneiro (Aug 12 2018 at 15:17)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131996986):
the idea is that if `e1` unfolds to `sum A B` and `e2` unfolds to `prod C D`, then it is impossible for `e1 == e2`

#### [Mario Carneiro (Aug 12 2018 at 15:18)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131997025):
even if `A B C D` are not completely unfolded

#### [Kevin Buzzard (Aug 12 2018 at 15:18)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131997026):
What does `==` mean?

#### [Mario Carneiro (Aug 12 2018 at 15:18)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131997028):
defeq

#### [Kevin Buzzard (Aug 12 2018 at 15:19)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131997030):
It's different to `=` because if two things are equal they must have the same type.

#### [Mario Carneiro (Aug 12 2018 at 15:19)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131997038):
it's not heq, I should use a better notation

#### [Kevin Buzzard (Aug 12 2018 at 15:19)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131997041):
Oh I see

#### [Mario Carneiro (Aug 12 2018 at 15:19)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131997042):
defeq things have to have the same type btw

#### [Kevin Buzzard (Aug 12 2018 at 15:19)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131997043):
great

#### [Mario Carneiro (Aug 12 2018 at 15:20)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131997088):
`expr tt` is `expr` and `expr ff` is `pexpr`

#### [Kevin Buzzard (Aug 12 2018 at 15:20)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131997092):
Oh!

#### [Mario Carneiro (Aug 12 2018 at 15:20)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131997094):
they have the same definition as inductive types so this saves some duplication

#### [Kevin Buzzard (Aug 12 2018 at 15:20)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131997095):
Oh these are optional paramaters

#### [Kevin Buzzard (Aug 12 2018 at 15:25)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/`a = b := rfl`/near/131997237):
```lean
run_cmd do
  e ← mk_const ``xena.zero,
  return e >>= trace
