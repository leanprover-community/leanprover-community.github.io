...
<p>FYI, the file I used is at <a href="https://github.com/PatrickMassot/lean-scratchpad/blob/master/src/demo.lean" target="_blank" title="https://github.com/PatrickMassot/lean-scratchpad/blob/master/src/demo.lean">https://github.com/PatrickMassot/lean-scratchpad/blob/master/src/demo.lean</a> it only depends on <a href="https://github.com/PatrickMassot/lean-scratchpad/blob/master/src/choice.lean" target="_blank" title="https://github.com/PatrickMassot/lean-scratchpad/blob/master/src/choice.lean">https://github.com/PatrickMassot/lean-scratchpad/blob/master/src/choice.lean</a> (and mathlib of course)</p>
...
<p>Of course it's focused on very explicit inefficient tactic mode, not code golf</p>
...
<p>I must say part of my plan is to use whatever insight and documentation you will continue to accumulate</p>
...
<p>You even managed to squeeze some French into the demo! Bonus points (-;</p>
...
<p>How valuable would it be to have (some) tutorials in video format? I'm wondering if it would be worth looking into doing that kind of presentation</p>
...
<p>I think videos could be nice. We could also have semi-interactive web pages with Lean code you could navigate and see the Lean status corresponding to each line, precomputed, not computed in real time. This should be a very easy exercise in using Lean in server mode.</p>
...
<p>I'm actually making a video in a couple of weeks, it was going to be a general one on dependent type theory. We have a bunch of fancy video-making kit at my university and some people are keen for me to try it out.</p>
