...
### Topic: [proof without rsimp](https://leanprover-community.github.io/archive/113488general/00230proofwithoutrsimp.html)
...
<p>Any suggestion on how to prove this? <code>rsimp</code> works, but I'm guessing there's a better way.</p>
...
<p>What are the types of things?</p>
...
<p><span class="user-mention" data-user-id="110049">@Mario Carneiro</span> Why isn't it a MWE? That's the entire context. What else do you need?</p>
...
<p>something he can copy-paste</p>
...
<p>DId you try making an <code>example</code> out of that? the motive of the <code>eq.rec</code> isn't inferrable</p>
...
<p>This is my current hacky proof progress:</p>
...
<p>Oh, I just realized I don't have <code>decidable_eq α</code>. Perhaps that's what's missing?</p>
...
<div class="codehilite"><pre><span></span>@[simp] theorem modify_id (a : array n α) (i : fin n) : a.modify i id = a :=
...
<p>Huh, looks like my hacks were doing something similar:</p>
...
<p><a href="/user_uploads/3121/xKzjHVDogyMIr2UJ8bK1i4vB/2018-07-17.png" target="_blank" title="2018-07-17.png">2018-07-17.png</a></p>
...
<p>tactic compilation != tactic execution</p>
...
<p>Profiler seems to be giving out strictly less info in javascript version</p>
...
<p><span class="user-mention" data-user-id="110064">@Kenny Lau</span> try <code>#check id</code> (or indeed anything) after the <code>rsimp</code> in the online version</p>
...
<p><a href="/user_uploads/3121/wbYWo5azpuBeH-w-iuMj3s4T/2018-07-17-1.png" target="_blank" title="2018-07-17-1.png">2018-07-17-1.png</a></p>
...
<p>Okay, so the allocations aren't what I thought they might be.</p>
