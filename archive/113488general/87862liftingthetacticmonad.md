...
#### [Scott Morrison (Aug 24 2018 at 09:50)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/lifting the tactic monad/near/132682369):
...
#### [Scott Morrison (Aug 24 2018 at 09:52)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/lifting the tactic monad/near/132682450):
...
#### [Scott Morrison (Aug 24 2018 at 09:52)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/lifting the tactic monad/near/132682468):
Is this something that others would find useful? If so, could we agree on a basic design that everyone would be happy with?

#### [Johan Commelin (Aug 24 2018 at 09:53)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/lifting the tactic monad/near/132682484):
...
#### [Johan Commelin (Aug 24 2018 at 09:53)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/lifting the tactic monad/near/132682490):
So you need to use `state_t`...

#### [Scott Morrison (Aug 24 2018 at 09:56)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/lifting the tactic monad/near/132682628):
Yes --- that's exactly another example of what I have in mind.

#### [Scott Morrison (Aug 24 2018 at 09:56)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/lifting the tactic monad/near/132682641):
The problem is now writing metatactics that are "monad polymorphic".

#### [Scott Morrison (Aug 24 2018 at 09:57)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/lifting the tactic monad/near/132682671):
...
#### [Scott Morrison (Aug 24 2018 at 10:03)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/lifting the tactic monad/near/132682966):
Ah, there is more in `state_t` than I'd seen before.

#### [Scott Morrison (Aug 24 2018 at 10:32)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/lifting the tactic monad/near/132684057):
...
#### [Scott Morrison (Aug 24 2018 at 10:45)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/lifting the tactic monad/near/132684651):
Clearly `state_t` isn't quite doing this: it doesn't even mention `tactic`.

#### [Rob Lewis (Aug 24 2018 at 11:05)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/lifting the tactic monad/near/132685496):
...
#### [Edward Ayers (Aug 24 2018 at 12:57)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/lifting the tactic monad/near/132690060):
```lean
...
#### [Edward Ayers (Aug 24 2018 at 13:00)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/lifting the tactic monad/near/132690204):
All of the `alternative` stuff works out of the box. `<|>`, `guard` and so on.

#### [Scott Morrison (Aug 24 2018 at 13:29)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/lifting the tactic monad/near/132691315):
...
#### [Scott Morrison (Aug 24 2018 at 13:29)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/lifting the tactic monad/near/132691330):
That is, sometimes I will write tactics that refer to some specific notion of state.

#### [Scott Morrison (Aug 24 2018 at 13:30)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/lifting the tactic monad/near/132691379):
...
#### [Edward Ayers (Aug 24 2018 at 14:02)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/lifting the tactic monad/near/132692605):
I guess if you are only storing bools nats and strings you can use `tactic.set_options` as a quick fix.

#### [Edward Ayers (Aug 24 2018 at 14:28)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/lifting the tactic monad/near/132693624):
...
#### [Edward Ayers (Aug 24 2018 at 14:29)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/lifting the tactic monad/near/132693642):
...
#### [Edward Ayers (Aug 24 2018 at 14:30)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/lifting the tactic monad/near/132693690):
I don't think this will work but I thought I'd share.

#### [Edward Ayers (Aug 24 2018 at 14:34)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/lifting the tactic monad/near/132693809):
...
#### [Reid Barton (Aug 24 2018 at 17:11)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/lifting the tactic monad/near/132701340):
...
#### [Reid Barton (Aug 24 2018 at 17:12)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/lifting the tactic monad/near/132701413):
But I'm not sure if this encompasses everything you want

#### [Sebastian Ullrich (Aug 24 2018 at 17:33)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/lifting the tactic monad/near/132702480):
`monad_state` is already in Lean 3. A `monad_tactic` might be introduced in Lean 4.

#### [Reid Barton (Aug 24 2018 at 17:50)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/lifting the tactic monad/near/132703270):
It would just be `has_monad_lift_t tactic`, right?

#### [Reid Barton (Aug 24 2018 at 17:50)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/lifting the tactic monad/near/132703274):
Up to specializing names

#### [Sebastian Ullrich (Aug 24 2018 at 17:56)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/lifting the tactic monad/near/132703524):
That is not sufficient for lifting `tactic _ -> tactic _` functions or even more complex ones

#### [Reid Barton (Aug 24 2018 at 18:07)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/lifting the tactic monad/near/132703985):
...
#### [Reid Barton (Aug 24 2018 at 18:07)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/lifting the tactic monad/near/132703997):
Maybe `tactic` has more compelling use cases

#### [Sebastian Ullrich (Aug 24 2018 at 18:12)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/lifting the tactic monad/near/132704242):
Yeah, it's way more important for `tactic` since it has a bunch of combinators like `try`, `focus`, `any_goals`, ...

#### [Edward Ayers (Aug 28 2018 at 13:51)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/lifting the tactic monad/near/132912880):
