...
<p>Happy birthday, <span class="user-mention" data-user-id="110038">@Kevin Buzzard</span>!</p>
...
<p>We made a little present for you.</p>
...
<p>I don't take birthdays at all seriously</p>
...
<p>but this is pretty awesome!</p>
...
<p>You mean examples, or just the definition? :-)</p>

#### [ Kevin Buzzard (Sep 21 2018 at 01:14)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Happy%20birthday%2C%20Kevin%21/near/134344133):
<p>who cares about examples :-)</p>
...
<p>I'm no expert, but I think that modular forms were among the projects done here</p>
...
<p>If only we had a number theorist to help out :)</p>
...
<p>I mentioned on the chat earlier today that I was going to have a day off work, but I didn't say why. I am 50 today (I have been for ten minutes in fact), which some people think is a big deal. I've spent so much time over the last few months just doing basic number theory / topology with random undergraduates many of whom do not even speak on this forum, I've had a really good time, it's meant that I've got behind on so many things but honestly Lean has changed my life for the better and I'm so pleased to be involved. Oh wow so much stuff I didn't know about!</p>
...
<p>This is just ridiculous, there is stuff here. It should all go in the "what's new in Lean maths" thread.</p>
...
<p>oh what a complete surprise!</p>
...
<p>I think Johan is pretty competent at modular forms :-)</p>
...
<p>Nobody ever gives me anything for my birthday, it is not taken at all seriously around here. I just get a new pair of trousers from my partner and that's it :-)</p>

#### [ Kevin Buzzard (Sep 21 2018 at 01:30)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Happy%20birthday%2C%20Kevin%21/near/134344910):
<p>This year I got modular forms!</p>
...
<p>My birthday present is a bit late, but I should have that refactor out today</p>
...
<p>Oh it's no hurry, it's timing :)</p>
...
<p>There are differentiable functions!</p>
...
<p>Happy birthday Kevin! <span class="emoji emoji-1f382" title="birthday">:birthday:</span> <span class="emoji emoji-1f603" title="smiley">:smiley:</span></p>
...
<p>Happy birthday! <span class="emoji emoji-1f389" title="tada">:tada:</span></p>
...
<p>Happy birthday! <span class="emoji emoji-1f382" title="birthday">:birthday:</span> <span class="emoji emoji-1f386" title="fireworks">:fireworks:</span> <span class="emoji emoji-1f38a" title="confetti">:confetti:</span></p>

#### [ Mario Carneiro (Sep 21 2018 at 08:45)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Happy%20birthday%2C%20Kevin%21/near/134360137):
<p>people keep finding more exciting emoji</p>
...
<p><span class="emoji emoji-1f382" title="birthday">:birthday:</span> <span class="emoji emoji-1f382" title="birthday">:birthday:</span> <span class="emoji emoji-1f382" title="birthday">:birthday:</span> <span class="emoji emoji-1f382" title="birthday">:birthday:</span> <span class="emoji emoji-1f382" title="birthday">:birthday:</span> <span class="emoji emoji-1f382" title="birthday">:birthday:</span> <span class="emoji emoji-1f382" title="birthday">:birthday:</span> <span class="emoji emoji-1f382" title="birthday">:birthday:</span> <span class="emoji emoji-1f382" title="birthday">:birthday:</span> <span class="emoji emoji-1f382" title="birthday">:birthday:</span></p>
...
<p><span class="emoji emoji-0035-20e3" title="five">:five:</span> <span class="emoji emoji-0030-20e3" title="zero">:zero:</span> <span class="emoji emoji-203c" title="double exclamation">:double_exclamation:</span></p>
...
<p><a href="http://www.wolframalpha.com/input/?i=50!!" target="_blank" title="http://www.wolframalpha.com/input/?i=50!!">520469842636666622693081088000000</a></p>
...
<p>not to be confused with <a href="http://www.wolframalpha.com/input/?i=50!+!" target="_blank" title="http://www.wolframalpha.com/input/?i=50!+!">10^(10^66.28958573684642)</a></p>
...
<p><span class="user-mention" data-user-id="110038">@Kevin Buzzard</span> Thanks for writing that question on mathoverflow. I am really excited and I look forward to the reactions.</p>
...
#### [ Kevin Buzzard (Sep 21 2018 at 14:14)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Happy%20birthday%2C%20Kevin%21/near/134373913):
<p>That's a really good suggestion. I think Hales' definition had sorries. Oh -- the issue is the analytic continuation. Convergence shouldn't be hard for the experts <em>now we have exp</em> :-)</p>
...
<p>But convergence is also not proved</p>
...
<p>Wait do we have <code>complex.pow</code>?</p>
...
<p>Does his definition compile?</p>
...
<p>nice to see pi there -- I heard we had that.</p>
...
<p>But this is just real log we need; complex exp but real log.</p>
...
<p>So we need that exp is strictly increasing and continuous, and enough analysis to show that it yields a bijection between the reals and the positive reals.</p>

#### [ Reid Barton (Sep 21 2018 at 14:41)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Happy%20birthday%2C%20Kevin%21/near/134375090):
<p>Yeah, this is an example of how it's tricky to say exactly what it means to define something. What Hales has done here is define a function <code>ζ</code> which, "externally", we can prove is equal to the usual zeta function.<br>
...
<p>So the first goal is to give a sorry-free definition of an explicit function from C -&gt; C which away from s = 1 agrees with the Riemann zeta function, possibly after invoking known mathematical theorems. Can we make it computable?</p>
...
<p>Can someone put Riemann Zeta Function on the MO thread?</p>
...
<p>I don't want to spam my own MO post with my own answers, this isn't an exercise in self-advertisement, it's a research proposal.</p>
...
<p>Right, I don't think you should spam it. But we shouldn't spam it either... I'dd be very interested in what "tabula rasa" mathematicians come up with. I might post something tomorrow.</p>
...
<p>Could that stream be made public now that the birthday surprise has been revealed?</p>

#### [ Johannes Hölzl (Sep 21 2018 at 18:33)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Happy%20birthday%2C%20Kevin%21/near/134388758):
<p>look for kbb, it should be public (at least I don't see a lock anymore)</p>
...
<p><span class="user-mention" data-user-id="110038">@Kevin Buzzard</span> Wow, I think the response to your mathoverflow post is really positive! I expected a lot (a lot!) more skepticism from the community. Maybe mathoverflow isn't completely representative. But still, I really like this. Apart from the thing about Inter-Universal Teichmuller Theory all the other proposals are actually nice (somewhat ambitious) and realisable.</p>
...
<p>The post has an immense rate of upvotes (a lot faster then your post about perfectoids in Lean). And the post doesn't even mention that you are turning 50 today <span class="emoji emoji-1f600" title="grinning">:grinning:</span></p>
...
<p>My pleasure! It was a lot of fun to work on these projects behind your back. But really <span class="user-mention" data-user-id="110044">@Chris Hughes</span> deserves an insane amount of credit. He did all the hard work on <code>exp</code> and <code>pi</code> all by himself.</p>
...
<p>well that was eventful. Thank you all for the encouragement. If anyone wants to write a guest blog post just ask.</p>
...
<p><span class="user-mention" data-user-id="110049">@Mario Carneiro</span> <span class="user-mention" data-user-id="110031">@Patrick Massot</span> What do you two think about the ideas <a href="https://mathoverflow.net/q/311071/91375" target="_blank" title="https://mathoverflow.net/q/311071/91375">here</a>?</p>

#### [ Mario Carneiro (Sep 27 2018 at 04:14)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/Happy%20birthday%2C%20Kevin%21/near/134716454):
<p>Woo, Kevin's MO question just hit the HNQ list, which means it will be seen across all of stack overflow</p>
...
<p>Kevin's question generated a noticeable bump in users on the stats page</p>
...
<p>"Locally presentable categories and combinatorial model categories please. Is it feasible ? I am actually discovering this thread and know nothing about Lean." says someone on the MO question, <span class="user-mention" data-user-id="110087">@Scott Morrison</span> ?</p>
...
<p>I think <span class="user-mention" data-user-id="110032">@Reid Barton</span> was talking about similar stuff in Orsay. This shouldn't be too far.</p>
...
<p>Yesterday I wrote about half of a detailed outline for model categories.<br>
