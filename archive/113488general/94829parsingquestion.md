...
#### [![Click to go to Zulip](../../assets/img/zulip2.png) Kevin Buzzard (Jan 19 2019 at 19:10)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/parsing%20question/near/156446241):
```lean
#print notation ->
-- _ `->`:25 _:24 := #1 → #2
```
...
#### [![Click to go to Zulip](../../assets/img/zulip2.png) Kevin Buzzard (Jan 19 2019 at 19:14)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/parsing%20question/near/156446351):
```
...
#### [![Click to go to Zulip](../../assets/img/zulip2.png) François G. Dorais (Jan 19 2019 at 19:53)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/parsing%20question/near/156447636):
From init/core: `def std.prec.arrow : nat := 25`

#### [![Click to go to Zulip](../../assets/img/zulip2.png) Kevin Buzzard (Jan 19 2019 at 20:09)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/parsing%20question/near/156448140):
...
#### [![Click to go to Zulip](../../assets/img/zulip2.png) Kevin Buzzard (Jan 19 2019 at 20:52)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/parsing%20question/near/156449546):
