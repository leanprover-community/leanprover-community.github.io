...
### Topic: [adding to someone else's PR](https://leanprover-community.github.io/archive/113488general/89510addingtosomeoneelsesPR.html)
...
<p>I can probably figure out how to add commutative rings myself, but this PR has not yet been accepted by mathlib and rather than having to wait for Mario twice</p>
...
<p>it seemed sensible just to add it now</p>
...
<p>Oh I see -- I send _you_ the PR?</p>
...
<p>You can directly push to PR branches of repositories you have push access to <a href="https://help.github.com/articles/committing-changes-to-a-pull-request-branch-created-from-a-fork/" target="_blank" title="https://help.github.com/articles/committing-changes-to-a-pull-request-branch-created-from-a-fork/">https://help.github.com/articles/committing-changes-to-a-pull-request-branch-created-from-a-fork/</a></p>
...
<p>I'm not sure I have push access to either mathlib or Kenny's fork of it</p>
...
<p>I can't fork Kenny's mathlib, github complains that I already have some other fork of mathlib</p>
...
<p>Kenny I've made my edits, I will just email them to you</p>
