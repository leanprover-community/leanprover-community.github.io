...
#### [Kenny Lau (Mar 08 2018 at 19:44)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/I can't build lean/near/123457140):
...
#### [Kenny Lau (Mar 08 2018 at 19:44)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/I can't build lean/near/123457142):
The error is kinda long and I don't know where to copy it from

#### [Kenny Lau (Mar 08 2018 at 19:52)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/I can't build lean/near/123457453):
https://github.com/leanprover/lean

#### [Kenny Lau (Mar 08 2018 at 19:52)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/I can't build lean/near/123457454):
nvm lean is still building

#### [Simon Hudon (Mar 08 2018 at 19:52)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/I can't build lean/near/123457457):
When you install Lean, where does it put the library? Try deleting that

#### [Kenny Lau (Mar 08 2018 at 19:56)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/I can't build lean/near/123457613):
I've got a new error

#### [Kenny Lau (Mar 08 2018 at 19:56)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/I can't build lean/near/123457614):
```
...
#### [Kenny Lau (Mar 08 2018 at 19:57)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/I can't build lean/near/123457639):
I've reverted to an older version by `git checkout`

#### [Kenny Lau (Mar 08 2018 at 19:57)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/I can't build lean/near/123457641):
and then I tried to build it again

#### [Simon Hudon (Mar 08 2018 at 19:58)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/I can't build lean/near/123457693):
Did you pick a revision which builds on Travis and AppVeyor?

#### [Kenny Lau (Mar 08 2018 at 19:58)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/I can't build lean/near/123457699):
I used `832d235` because Kevin Buzzard is currently running on that

#### [Kenny Lau (Mar 08 2018 at 19:59)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/I can't build lean/near/123457703):
how do I check if it builds on Travis and AppVeyor?

#### [Simon Hudon (Mar 08 2018 at 20:01)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/I can't build lean/near/123457826):
You can go: https://github.com/leanprover/lean/commits/master

The commits that pass both have a green check mark

#### [Kenny Lau (Mar 08 2018 at 20:02)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/I can't build lean/near/123457889):
the last green check mark is March 2 :o

#### [Mario Carneiro (Mar 08 2018 at 20:03)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/I can't build lean/near/123457903):
...
#### [Kenny Lau (Mar 08 2018 at 20:03)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/I can't build lean/near/123457913):
oh thanks, lemme try

#### [Kenny Lau (Mar 08 2018 at 20:04)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/I can't build lean/near/123457963):
but should I just go with the green check marks

#### [Mario Carneiro (Mar 08 2018 at 20:06)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/I can't build lean/near/123458050):
...
#### [Kenny Lau (Mar 08 2018 at 20:15)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/I can't build lean/near/123458375):
@**Mario Carneiro** I deleted lean.exe, now it's complaining that lean.exe isn't there

#### [Mario Carneiro (Mar 08 2018 at 20:15)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/I can't build lean/near/123458388):
see my last comment

#### [Mario Carneiro (Mar 08 2018 at 20:15)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/I can't build lean/near/123458408):
open any cpp file, add and delete a space somewhere, and save, then run ninja again

#### [Kenny Lau (Mar 08 2018 at 20:16)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/I can't build lean/near/123458452):
oh

#### [Kenny Lau (Mar 08 2018 at 20:16)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/I can't build lean/near/123458456):
nice

#### [Kenny Lau (Mar 08 2018 at 20:19)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/I can't build lean/near/123458579):
parabens por mim, it worked

#### [Kevin Buzzard (Mar 08 2018 at 20:22)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/I can't build lean/near/123458722):
