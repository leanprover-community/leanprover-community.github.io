...
#### [Kevin Sullivan (Aug 03 2018 at 15:02)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/namespace design issues vs. pedagogy/near/130837483):
...
#### [Johan Commelin (Aug 03 2018 at 15:03)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/namespace design issues vs. pedagogy/near/130837541):
...
#### [Kevin Sullivan (Aug 03 2018 at 15:03)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/namespace design issues vs. pedagogy/near/130837550):
```quote
The context for the following is an effort to use Lean in teaching a lower-level undergraduate course. Students are easily confused. I'm trying to use namespaces in the usual way so that we can recapitulate the definitions of built-in types, such as bool, without getting name conflicts. It "works", but in the course of figuring out the details, I noted some inconsistencies that I myself found confusing and that students are likely to find confusing, too. I comment the code. The key lines are marked AAA through EEE.
...
#### [Kevin Sullivan (Aug 03 2018 at 15:05)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/namespace design issues vs. pedagogy/near/130837633):
```quote
Kevin, you can use three backticks around your code to create a codeblock. If you write "lean" after the first set of backticks you get syntax highlighting! Like so
```
```lean
...
#### [Simon Hudon (Aug 03 2018 at 15:45)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/namespace design issues vs. pedagogy/near/130839743):
I think the take away from AAA through CCC is that when you use `open` you must fully qualify the name that you use.

#### [Simon Hudon (Aug 03 2018 at 15:51)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/namespace design issues vs. pedagogy/near/130840086):
This might provide some more helpful details: https://leanprover.github.io/reference/other_commands.html#namespaces

#### [Kevin Buzzard (Aug 03 2018 at 18:57)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/namespace design issues vs. pedagogy/near/130850440):
...
#### [Kevin Buzzard (Aug 03 2018 at 19:02)](https://leanprover.zulipchat.com/#narrow/stream/113488-general/topic/namespace design issues vs. pedagogy/near/130850682):
