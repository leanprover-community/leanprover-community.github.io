...
<p>The challenge is extremely easy to state: say you have a colleague who wants to try maths in Lean, either on Linux, MacOS or Windows. We want him to download one file, execute it, wait at most 3 minutes, and be ready to fire either emacs or VScode and  play.</p>
...
<p>That would be a hugely useful achievement</p>
...
<p>If they know emacs, they know how to do the rest themselves as well...</p>
...
<p>I meant the colleague should be able to choose between emacs and VScode.</p>
...
<p>I guess it's fair to assume emacs is already installed if the colleague want to use emacs, but the default stuff should be to install VScode along the way, unless the user explicitly refuses to get it.</p>
...
<p>Oh, I didn't get that from your first message.</p>
...
<p>No idea who could have money for that, except MS of course</p>
...
<p>But I'm pretty sure Leo won't be interested right now</p>
...
<p>I could maybe ask for some money from SICSA, but it's a bit hard given that this isn't, strictly speaking, research: <a href="http://www.sicsa.ac.uk/funding/" target="_blank" title="http://www.sicsa.ac.uk/funding/">http://www.sicsa.ac.uk/funding/</a></p>
...
<p>I don't think any of the clients we normally work with would care enough to fund this type of work either.</p>
...
<p>I realise that Leo has very different priorities, and I actually think this is entirely justifiable.</p>
...
<p>Another idea, which comes to mind is Google Summer of Code, but this is a lot of work, lean would have to become an affiliated partner, etc.</p>
...
<p>I don't think I'd be able to commit to such a big task as coordinating GSoC.</p>
...
<p>I don't think GSoC would be interested in helping packaging, and actual contributions to Lean are far beyond the scope of GSoC</p>
...
<p>The thing is, I'm pretty sure, if we get all the pipelines with all the installers nicely polished, swapping the binary from Lean 3 to Lean 4 would be no problem at all.</p>
...
<p>Well, anyway, let's keep thinking about these options, maybe somebody will get a good idea for a funding stream.</p>
...
<p>There are also intermediate goals that should be reachable, like having Travis building mathlib nightly olean, copying what works for lean nightlies</p>
...
<p>Marcell's done plenty of travis builds, both before and after we've started working together.</p>
...
<p>There's this website, which lists some possibilities: <a href="https://www.software.ac.uk/how-fund-research-software-development" target="_blank" title="https://www.software.ac.uk/how-fund-research-software-development">https://www.software.ac.uk/how-fund-research-software-development</a></p>
...
<p>I'll investigate and let you guys know what I've found</p>
