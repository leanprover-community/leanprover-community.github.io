...
<p>I'm trying to please Johannes who doesn't like</p>
<div class="codehilite"><pre><span></span><span class="kn">example</span> <span class="o">(</span><span class="n">p</span> <span class="n">q</span> <span class="n">r</span> <span class="n">s</span> <span class="o">:</span> <span class="kt">Prop</span><span class="o">)</span> <span class="o">(</span><span class="n">h</span> <span class="o">:</span> <span class="n">p</span> <span class="bp">↔</span> <span class="n">q</span><span class="o">)</span> <span class="o">(</span><span class="n">h&#39;</span> <span class="o">:</span> <span class="n">q</span> <span class="bp">→</span> <span class="n">r</span><span class="o">)</span> <span class="o">(</span><span class="n">h&#39;&#39;</span> <span class="o">:</span> <span class="n">r</span> <span class="bp">↔</span> <span class="n">s</span><span class="o">)</span> <span class="o">:</span> <span class="n">p</span> <span class="bp">→</span> <span class="n">s</span> <span class="o">:=</span>
...
<p>If only <code>Prop</code> were a category... then you could write</p>
<div class="codehilite"><pre><span></span><span class="kn">example</span> <span class="o">(</span><span class="n">p</span> <span class="n">q</span> <span class="n">r</span> <span class="n">s</span> <span class="o">:</span> <span class="kt">Prop</span><span class="o">)</span> <span class="o">(</span><span class="n">h</span> <span class="o">:</span> <span class="n">p</span> <span class="bp">↔</span> <span class="n">q</span><span class="o">)</span> <span class="o">(</span><span class="n">h&#39;</span> <span class="o">:</span> <span class="n">q</span> <span class="bp">→</span> <span class="n">r</span><span class="o">)</span> <span class="o">(</span><span class="n">h&#39;&#39;</span> <span class="o">:</span> <span class="n">r</span> <span class="bp">↔</span> <span class="n">s</span><span class="o">)</span> <span class="o">:</span> <span class="n">p</span> <span class="bp">→</span> <span class="n">s</span> <span class="o">:=</span>
...
<p>Maybe I should say that the actual proof would rather look like</p>
...
<p>unfortunately no. Here's the best we can do:</p>
...
<p>If you replace <code>→→</code> with <code>→</code> the trans lemmas are rejected</p>
...
<p>because <code>→</code> is a bit magic for a binary operator</p>
...
<p>This magic obstruction is what I suspected when I tried to define those trans lemmas</p>
...
<p>Here is the best I could do in order to rewrite my continuity proof so that it looks like what I see on paper:</p>
...
<p>How do you like that style?</p>
...
<p>It's really a pain that <code>le_refl</code> isn't inserted automatically</p>
...
<p>what's wrong with the current proof?</p>
...
<p>I have added <code>le_refl</code> to the simp set in my mathlib. I will probably PR it one day, together with a lot of other stuff (but cut into atomic pieces, if this is the way we should do PRs), once (or if?) my two topology PRs are merged.</p>
...
<p>Kenny, the current proof is inelegant. Remember that only Lean thinks proofs are irrelevant</p>
...
<p>eh, I also think they're irrelevant</p>
...
<p><span class="user-mention" data-user-id="110038">@Kevin Buzzard</span> You've created little monsters <span class="emoji emoji-1f631" title="scream">:scream:</span>. Clearly they need to be brought up in the ways of the old masters, who value the esthetics of a good proof, and whose proofs illuminate and inspire understanding.</p>
...
<p>looks like he will PR it after Lean 4 has been released</p>
...
<p>yeah okay. I've been putting it off because it's a big PR and I had to check it out and fiddle with stuff, but I will work on that now</p>
