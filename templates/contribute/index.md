...
(Labels can only be edited by "GitHub collaborators", which is approximately the same as "people who have write access".) Anyone can edit the labels by writing the following comments:
- `awaiting-author` will add the **"awaiting-author"** label
- (To be added) will remove the **"awaiting-author"** label
- `WIP` will add the **"WIP"** label
- (To be added) will remove the **"WIP"** label
