...
[Code of Conduct]. In short, be respectful. However, when reviewing please be
...
- [does it adhere to style?](#style)
    ...
    + is the [PR title](link-to-commit-conventions) and description appropriately informative?
...
```lean
theorem inv_is_unit_times_self_eq_1 {M : Type _} [Monoid M] {a : M} (h : IsUnit a) :
