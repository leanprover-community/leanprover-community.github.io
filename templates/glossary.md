...
A *code linter* is a [linter](#lint) which attempts to find unintentional mistakes in Lean declarations.
...
There are also [code linters](#code-linter) (which run on individual declarations) and [style linters](#style-linter) (which run on literal source text).
...
[Mathlib](#Mathlib) includes [code linters](#code-linter), [environment linters](#environment-linter), and [style linters](#style-linter).
