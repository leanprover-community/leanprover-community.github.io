...
Linting can be disabled for a particular piece of code, which will be indicated in an autogenerated [nolint file](https://github.com/leanprover-community/mathlib/blob/master/scripts/nolints.txt).
